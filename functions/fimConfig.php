...
class fimConfig {
    ...
    public static $fullTextArchive = false;

    /** @var int The minimum length a string must be to be added to the "phrase" table. */
    public static $searchWordMinimum = 4;
    /** @var int The maximum length a string can be to be added to the "phrase" table. */
    public static $searchWordMaximum = 12;
    /** @var array Words that not wll be omitted from the "phrase" table. */
    public static $searchWordOmissions = array('that','them','then','than','thus','have','with','will','would','there','their','what','about','when','make','like','also','think','over','into','time','year','just','know','take','which','about','back','after','well','even','want','because','these','most');
    ...
    /* File Uploads */
    public static $fileSuffixes = array('B', 'KiB', 'MiB', 'GiB', 'PiB', 'EiB', 'ZiB', 'YiB');
    public static $fileIncrementSize = 1024;
    ...
    public static $fileUploadChunkSize = 1024;
    ...
    public static $imageTypes = array('gif', 'png', 'jpg');
    ...
    public static $uploadMimeProof = array('gif', 'jpg', 'png');
    ...
    public static $roomPermissionsCacheAutoUpdate = true; // bool
    ...
    /* XML Output */
    public static $compactJsonStringsFind = array('/\ {2,}/', "/(\n|\n\r|\t|\r)/");
    public static $compactJsonStringsReplace = array('', '');
