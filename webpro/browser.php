  ...
  <html>
    <head>
      <title>FreezeMessenger v3.0 - Please Upgrade Your Browser!</title>
    ...
    <body class="body">
      <div class="main">
        ...
        <p><b><a href="http://www.mozilla.com/en-US/firefox/new/">Mozilla Firefox</a> (Windows 2000/XP/Vista/7, Mac OS X 10.5+, Linux)</b> - Mozilla Firefox is a browser developed many years ago as a spiritual successor to Netscap. It is by far the most full-featured and powerful web browser out there, while its advanced plugin interface allows you to experience the Internet the way you like.</p>
      </div>
    </body>
  </html>