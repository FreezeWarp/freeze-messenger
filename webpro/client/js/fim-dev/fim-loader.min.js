...
"Bridge").val());return!1}));$('<input type="hidden" name="'+this.options.name+'" id="'+this.options.name+'">').insertAfter(a);"default"in b&&this.displayEntries(b.default);return this};
