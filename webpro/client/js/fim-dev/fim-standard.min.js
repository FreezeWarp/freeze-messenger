var standard=function(){};standard.prototype.initialLogin=function(b){oldFinish=b.finish;b.finish=function(a){oldFinish&&oldFinish(a);window.anonId||($.cookie("webpro_username",b.username,{expires:14}),$.cookie("webpro_password",b.password,{expires:14}),fimApi.getUnreadMessages(null,{each:function(a){fim_showMissedMessage(a)}}));window.roomId||(window.roomId=a.userData.defaultRoomId?a.userData.defaultRoomId:1);fim_renderHandlebarsInPlace($("#entry-template"));fim_hashParse()};standard.login(b)};
