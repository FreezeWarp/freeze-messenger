...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,h,a){b instanceof String&&(b=String(b));for(var e=b.length,c=0;c<e;c++){var f=b[c];if(h.call(a,f,c,b))return{i:c,v:f}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(b,h,a){b!=Array.prototype&&b!=Object.prototype&&(b[h]=a.value)};
$jscomp.getGlobal=function(b){return"undefined"!=typeof window&&window===b?b:"undefined"!=typeof global&&null!=global?global:b};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(b,h,a,e){if(h){a=$jscomp.global;b=b.split(".");for(e=0;e<b.length-1;e++){var c=b[e];c in a||(a[c]={});a=a[c]}b=b[b.length-1];e=a[b];h=h(e);h!=e&&null!=h&&$jscomp.defineProperty(a,b,{configurable:!0,writable:!0,value:h})}};
$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(b,a){return $jscomp.findInternal(this,b,a).v}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.Symbol=function(){var b=0;return function(h){return $jscomp.SYMBOL_PREFIX+(h||"")+b++}}();
...
$jscomp.iteratorPrototype=function(b){$jscomp.initSymbolIterator();b={next:b};b[$jscomp.global.Symbol.iterator]=function(){return this};return b};$jscomp.iteratorFromArray=function(b,h){$jscomp.initSymbolIterator();b instanceof String&&(b+="");var a=0,e={next:function(){if(a<b.length){var c=a++;return{value:h(c,b[c]),done:!1}}e.next=function(){return{done:!0,value:void 0}};return e.next()}};e[Symbol.iterator]=function(){return e};return e};
...
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"===typeof exports?b(require("jquery")):b(jQuery)})(function(b){var h=0,a=Array.prototype.slice;b.cleanData=function(a){return function(c){var e,k,n;for(n=0;null!=(k=c[n]);n++)try{(e=b._data(k,"events"))&&e.remove&&b(k).triggerHandler("remove")}catch(m){}a(c)}}(b.cleanData);b.widget=function(a,c,f){var e={},n=a.split(".")[0];a=a.split(".")[1];var m=n+"-"+a;f||(f=c,c=b.Widget);b.expr[":"][m.toLowerCase()]=function(d){return!!b.data(d,
m)};b[n]=b[n]||{};var d=b[n][a];var g=b[n][a]=function(d,b){if(!this._createWidget)return new g(d,b);arguments.length&&this._createWidget(d,b)};b.extend(g,d,{version:f.version,_proto:b.extend({},f),_childConstructors:[]});var l=new c;l.options=b.widget.extend({},l.options);b.each(f,function(d,a){b.isFunction(a)?e[d]=function(){var b=function(){return c.prototype[d].apply(this,arguments)},g=function(b){return c.prototype[d].apply(this,b)};return function(){var d=this._super,c=this._superApply;this._super=
b;this._superApply=g;var e=a.apply(this,arguments);this._super=d;this._superApply=c;return e}}():e[d]=a});g.prototype=b.widget.extend(l,{widgetEventPrefix:d?l.widgetEventPrefix||a:a},e,{constructor:g,namespace:n,widgetName:a,widgetFullName:m});d?(b.each(d._childConstructors,function(d,a){d=a.prototype;b.widget(d.namespace+"."+d.widgetName,g,a._proto)}),delete d._childConstructors):c._childConstructors.push(g);b.widget.bridge(a,g);return g};b.widget.extend=function(e){for(var c=a.call(arguments,1),
f=0,k=c.length,n,m;f<k;f++)for(n in c[f])m=c[f][n],c[f].hasOwnProperty(n)&&void 0!==m&&(b.isPlainObject(m)?e[n]=b.isPlainObject(e[n])?b.widget.extend({},e[n],m):b.widget.extend({},m):e[n]=m);return e};b.widget.bridge=function(e,c){var f=c.prototype.widgetFullName||e;b.fn[e]=function(k){var n="string"===typeof k,m=a.call(arguments,1),d=this;n?this.each(function(){var a=b.data(this,f);if("instance"===k)return d=a,!1;if(!a)return b.error("cannot call methods on "+e+" prior to initialization; attempted to call method '"+
k+"'");if(!b.isFunction(a[k])||"_"===k.charAt(0))return b.error("no such method '"+k+"' for "+e+" widget instance");var c=a[k].apply(a,m);if(c!==a&&void 0!==c)return d=c&&c.jquery?d.pushStack(c.get()):c,!1}):(m.length&&(k=b.widget.extend.apply(null,[k].concat(m))),this.each(function(){var d=b.data(this,f);d?(d.option(k||{}),d._init&&d._init()):b.data(this,f,new c(k,this))}));return d}};b.Widget=function(){};b.Widget._childConstructors=[];b.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",
...
this.bindings.unbind(this.eventNamespace);this.hoverable.removeClass("ui-state-hover");this.focusable.removeClass("ui-state-focus")},_destroy:b.noop,widget:function(){return this.element},option:function(a,c){var e=a,k;if(0===arguments.length)return b.widget.extend({},this.options);if("string"===typeof a){e={};var n=a.split(".");a=n.shift();if(n.length){var m=e[a]=b.widget.extend({},this.options[a]);for(k=0;k<n.length-1;k++)m[n[k]]=m[n[k]]||{},m=m[n[k]];a=n.pop();if(1===arguments.length)return void 0===
m[a]?null:m[a];m[a]=c}else{if(1===arguments.length)return void 0===this.options[a]?null:this.options[a];e[a]=c}}this._setOptions(e);return this},_setOptions:function(b){for(var a in b)this._setOption(a,b[a]);return this},_setOption:function(b,a){this.options[b]=a;"disabled"===b&&(this.widget().toggleClass(this.widgetFullName+"-disabled",!!a),a&&(this.hoverable.removeClass("ui-state-hover"),this.focusable.removeClass("ui-state-focus")));return this},enable:function(){return this._setOptions({disabled:!1})},
disable:function(){return this._setOptions({disabled:!0})},_on:function(a,c,f){var e,n=this;"boolean"!==typeof a&&(f=c,c=a,a=!1);f?(c=e=b(c),this.bindings=this.bindings.add(c)):(f=c,c=this.element,e=this.widget());b.each(f,function(k,d){function g(){if(a||!0!==n.options.disabled&&!b(this).hasClass("ui-state-disabled"))return("string"===typeof d?n[d]:d).apply(n,arguments)}"string"!==typeof d&&(g.guid=d.guid=d.guid||g.guid||b.guid++);var l=k.match(/^([\w:-]*)\s*(.*)$/);k=l[1]+n.eventNamespace;(l=l[2])?
...
mouseleave:function(a){b(a.currentTarget).removeClass("ui-state-hover")}})},_focusable:function(a){this.focusable=this.focusable.add(a);this._on(a,{focusin:function(a){b(a.currentTarget).addClass("ui-state-focus")},focusout:function(a){b(a.currentTarget).removeClass("ui-state-focus")}})},_trigger:function(a,c,f){var e,n=this.options[a];f=f||{};c=b.Event(c);c.type=(a===this.widgetEventPrefix?a:this.widgetEventPrefix+a).toLowerCase();c.target=this.element[0];if(a=c.originalEvent)for(e in a)e in c||
(c[e]=a[e]);this.element.trigger(c,f);return!(b.isFunction(n)&&!1===n.apply(this.element[0],[c].concat(f))||c.isDefaultPrevented())}};b.each({show:"fadeIn",hide:"fadeOut"},function(a,c){b.Widget.prototype["_"+a]=function(e,k,n){"string"===typeof k&&(k={effect:k});var f=k?!0===k||"number"===typeof k?c:k.effect||c:a;k=k||{};"number"===typeof k&&(k={duration:k});var d=!b.isEmptyObject(k);k.complete=n;k.delay&&e.delay(k.delay);if(d&&b.effects&&b.effects.effect[f])e[a](k);else if(f!==a&&e[f])e[f](k.duration,
k.easing,n);else e.queue(function(d){b(this)[a]();n&&n.call(e[0]);d()})}})});jQuery.fn.extend({autocompleteHelper:function(b,h){function a(a,c){a.val()?$.when(Resolver.resolveFromName(b,a.val())).then(function(b){b[a.val()]?(a.attr("data-value",b[a.val()].name),a.attr("data-id",b[a.val()].id),a.removeClass("is-invalid"),a.trigger("autocompleteChange")):(a.attr("data-id",""),a.attr("data-value",""),a.addClass("is-invalid"));c&&c()}):(a.attr("data-id",""),a.attr("data-value",""),a.removeClass("is-invalid"),a.trigger("autocompleteChange"),c&&c())}var e=this,c=$('<input class="js-typeahead form-control" type="search" autocomplete="off" />');
jQuery.each(["name","id","placeholder"],function(b,a){e.attr(a)&&c.attr(a,e.attr(a))});var f=$('<div class="typeahead__container form-control-container">').append($('<div class="typeahead__field">').append($('<span class="typeahead__query">').append(c)));this.replaceWith(f);c.typeahead({display:["name"],order:"asc",minLength:1,dynamic:!0,source:{users:{ajax:{url:fimApi.directory+"api/acHelper.php",data:{access_token:fimApi.lastSessionHash,list:b,search:"{{query}}"},path:"entries"}}},template:function(b,
a){return a.avatar?'<span class="userName userNameAvatar"><img src="{{avatar}}" style="max-width: 20px; max-height: 20px;"/> <span>{{name}}</span></span>':"<span>{{name}}</span>"},callback:{onClick:function(b,a,c,d){$(b).val(c.name);$(b).attr("data-id",c.id);$(b).attr("data-value",c.name);$(b).removeClass("is-invalid");$(b).trigger("autocompleteChange").change()},onCancel:function(b,a){$(b).attr("data-id","");$(b).attr("data-value","");$(b).removeClass("is-invalid");$(b).trigger("autocompleteChange").change()}}});
...
a(c,function(){$(b.target).trigger("submit")}),!1)});h?$.when(Resolver.resolveFromId(b,h)).then(function(b){c.val(b[h].name);c.attr("data-value",b[h].name);c.attr("data-id",h)}):(c.val(""),c.attr("data-id",""),c.attr("data-value",""));return c}});(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"===typeof exports?b(require("jquery")):b(jQuery)})(function(b){function h(a){var c=!1;b('[data-notify="container"]').each(function(e,f){e=b(f);f=e.find('[data-notify="title"]').html().trim();var k=e.find('[data-notify="message"]').html().trim();f=f===b("<div>"+a.settings.content.title+"</div>").html().trim();k=k===b("<div>"+a.settings.content.message+"</div>").html().trim();e=e.hasClass("alert-"+a.settings.type);f&&k&&
e&&(c=!0);return!c});return c}function a(a,f,k){k=b.extend(!0,{},{content:{message:"object"===typeof f?f.message:f,title:f.title?f.title:"",icon:f.icon?f.icon:"",url:f.url?f.url:"#",target:f.target?f.target:"-"}},k);this.settings=b.extend(!0,{},e,k);this._defaults=e;"-"===this.settings.content.target&&(this.settings.content.target=this.settings.url_target);this.animations={start:"webkitAnimationStart oanimationstart MSAnimationStart animationstart",end:"webkitAnimationEnd oanimationend MSAnimationEnd animationend"};
"number"===typeof this.settings.offset&&(this.settings.offset={x:this.settings.offset,y:this.settings.offset});(this.settings.allow_duplicates||!this.settings.allow_duplicates&&!h(this))&&this.init()}var e={element:"body",position:null,type:"info",allow_dismiss:!0,allow_duplicates:!0,newest_on_top:!1,showProgressbar:!1,placement:{from:"top",align:"right"},offset:20,spacing:10,z_index:1031,delay:5E3,timer:1E3,url_target:"_blank",mouse_over:null,animate:{enter:"animated fadeInDown",exit:"animated fadeOutUp"},
...
String.format=function(){var b=arguments;return arguments[0].replace(/(\{\{\d\}\}|\{\d\})/g,function(a){if("{{"===a.substring(0,2))return a;a=parseInt(a.match(/\d/)[0]);return b[a+1]})};b.extend(a.prototype,{init:function(){var b=this;this.buildNotify();this.settings.content.icon&&this.setIcon();"#"!=this.settings.content.url&&this.styleURL();this.styleDismiss();this.placement();this.bind();this.notify={$ele:this.$ele,update:function(a,c){var e={};"string"===typeof a?e[a]=c:e=a;for(var f in e)switch(f){case "type":this.$ele.removeClass("alert-"+
b.settings.type);this.$ele.find('[data-notify="progressbar"] > .progress-bar').removeClass("progress-bar-"+b.settings.type);b.settings.type=e[f];this.$ele.addClass("alert-"+e[f]).find('[data-notify="progressbar"] > .progress-bar').addClass("progress-bar-"+e[f]);break;case "icon":c=this.$ele.find('[data-notify="icon"]');"class"===b.settings.icon_type.toLowerCase()?c.removeClass(b.settings.content.icon).addClass(e[f]):(c.is("img")||c.find("img"),c.attr("src",e[f]));b.settings.content.icon=e[a];break;
case "progress":this.$ele.data("notify-delay",b.settings.delay-e[f]/100*b.settings.delay);this.$ele.find('[data-notify="progressbar"] > div').attr("aria-valuenow",e[f]).css("width",e[f]+"%");break;case "url":this.$ele.find('[data-notify="url"]').attr("href",e[f]);break;case "target":this.$ele.find('[data-notify="url"]').attr("target",e[f]);break;default:this.$ele.find('[data-notify="'+f+'"]').html(e[f])}a=this.$ele.outerHeight()+parseInt(b.settings.spacing)+parseInt(b.settings.offset.y);b.reposition(a)},
...
2})},styleURL:function(){this.$ele.find('[data-notify="url"]').css({backgroundImage:"url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)",height:"100%",left:0,position:"absolute",top:0,width:"100%",zIndex:this.settings.z_index+1})},placement:function(){var a=this,e=this.settings.offset.y,k={display:"inline-block",margin:"0px auto",position:this.settings.position?this.settings.position:"body"===this.settings.element?"fixed":"absolute",transition:"all .5s ease-in-out",
zIndex:this.settings.z_index},h=!1,m=this.settings;b('[data-notify-position="'+this.settings.placement.from+"-"+this.settings.placement.align+'"]:not([data-closing="true"])').each(function(){e=Math.max(e,parseInt(b(this).css(m.placement.from))+parseInt(b(this).outerHeight())+parseInt(m.spacing))});!0===this.settings.newest_on_top&&(e=this.settings.offset.y);k[this.settings.placement.from]=e+"px";switch(this.settings.placement.align){case "left":case "right":k[this.settings.placement.align]=this.settings.offset.x+
"px";break;case "center":k.left=0,k.right=0}this.$ele.css(k).addClass(this.settings.animate.enter);b.each(["webkit-","moz-","o-","ms-",""],function(b,g){a.$ele[0].style[g+"AnimationIterationCount"]=1});b(this.settings.element).append(this.$ele);!0===this.settings.newest_on_top&&(e=parseInt(e)+parseInt(this.settings.spacing)+this.$ele.outerHeight(),this.reposition(e));b.isFunction(a.settings.onShow)&&a.settings.onShow.call(this.$ele);this.$ele.one(this.animations.start,function(){h=!0}).one(this.animations.end,
function(){a.$ele.removeClass(a.settings.animate.enter);b.isFunction(a.settings.onShown)&&a.settings.onShown.call(this)});setTimeout(function(){h||b.isFunction(a.settings.onShown)&&a.settings.onShown.call(this)},600)},bind:function(){var a=this;this.$ele.find('[data-notify="dismiss"]').on("click",function(){a.close()});if(b.isFunction(a.settings.onClick))this.$ele.on("click",function(b){b.target!=a.$ele.find('[data-notify="dismiss"]')[0]&&a.settings.onClick.call(this,b)});this.$ele.mouseover(function(){b(this).data("data-hover",
"true")}).mouseout(function(){b(this).data("data-hover","false")});this.$ele.data("data-hover","false");if(0<this.settings.delay){a.$ele.data("notify-delay",a.settings.delay);var e=setInterval(function(){var b=parseInt(a.$ele.data("notify-delay"))-a.settings.timer;if("false"===a.$ele.data("data-hover")&&"pause"===a.settings.mouse_over||"pause"!=a.settings.mouse_over){var c=(a.settings.delay-b)/a.settings.delay*100;a.$ele.data("notify-delay",b);a.$ele.find('[data-notify="progressbar"] > div').attr("aria-valuenow",
c).css("width",c+"%")}b<=-a.settings.timer&&(clearInterval(e),a.close())},a.settings.timer)}},close:function(){var a=this,e=parseInt(this.$ele.css(this.settings.placement.from)),k=!1;this.$ele.attr("data-closing","true").addClass(this.settings.animate.exit);a.reposition(e);b.isFunction(a.settings.onClose)&&a.settings.onClose.call(this.$ele);this.$ele.one(this.animations.start,function(){k=!0}).one(this.animations.end,function(){b(this).remove();b.isFunction(a.settings.onClosed)&&a.settings.onClosed.call(this)});
setTimeout(function(){k||(a.$ele.remove(),b.isFunction(a.settings.onClosed)&&a.settings.onClosed.call(this))},600)},reposition:function(a){var c=this,e='[data-notify-position="'+this.settings.placement.from+"-"+this.settings.placement.align+'"]:not([data-closing="true"])',h=this.$ele.nextAll(e);!0===this.settings.newest_on_top&&(h=this.$ele.prevAll(e));h.each(function(){b(this).css(c.settings.placement.from,a);a=parseInt(a)+parseInt(c.settings.spacing)+b(this).outerHeight()})}});b.notify=function(b,
e){return(new a(this,b,e)).notify};b.notifyDefaults=function(a){return e=b.extend(!0,{},e,a)};b.notifyClose=function(a){"undefined"===typeof a||"all"===a?b("[data-notify]").find('[data-notify="dismiss"]').trigger("click"):"success"===a||"info"===a||"warning"===a||"danger"===a?b(".alert-"+a+"[data-notify]").find('[data-notify="dismiss"]').trigger("click"):a?b(a+"[data-notify]").find('[data-notify="dismiss"]').trigger("click"):b('[data-notify-position="'+a+'"]').find('[data-notify="dismiss"]').trigger("click")};
b.notifyCloseExcept=function(a){"success"===a||"info"===a||"warning"===a||"danger"===a?b("[data-notify]").not(".alert-"+a).find('[data-notify="dismiss"]').trigger("click"):b("[data-notify]").not(a).find('[data-notify="dismiss"]').trigger("click")}});(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"===typeof exports?b(require("jquery")):b(jQuery)})(function(b){function h(b){b=b.split(/\s+/);for(var a=[],d=0,g;g=b[d];d++)g=g.charAt(0).toUpperCase(),a.push(g);return a}function a(a){return a.id&&b('label[for="'+a.id+'"]').val()||a.name}function e(d,g,c){c||(c=0);g.each(function(){var g=b(this),p=this,y=this.nodeName.toLowerCase();if("label"===y&&g.find("input, textarea, select").length){var l=g.text();g=g.children().first();
p=g.get(0);y=p.nodeName.toLowerCase()}switch(y){case "menu":var f={name:g.attr("label"),items:{}};c=e(f.items,g.children(),c);break;case "a":case "button":f={name:g.text(),disabled:!!g.attr("disabled"),callback:function(){return function(){g.get(0).click()}}()};break;case "menuitem":case "command":switch(g.attr("type")){case void 0:case "command":case "menuitem":f={name:g.attr("label"),disabled:!!g.attr("disabled"),icon:g.attr("icon"),callback:function(){return function(){g.get(0).click()}}()};break;
case "checkbox":f={type:"checkbox",disabled:!!g.attr("disabled"),name:g.attr("label"),selected:!!g.attr("checked")};break;case "radio":f={type:"radio",disabled:!!g.attr("disabled"),name:g.attr("label"),radio:g.attr("radiogroup"),value:g.attr("id"),selected:!!g.attr("checked")};break;default:f=void 0}break;case "hr":f="-------";break;case "input":switch(g.attr("type")){case "text":f={type:"text",name:l||a(p),disabled:!!g.attr("disabled"),value:g.val()};break;case "checkbox":f={type:"checkbox",name:l||
a(p),disabled:!!g.attr("disabled"),selected:!!g.attr("checked")};break;case "radio":f={type:"radio",name:l||a(p),disabled:!!g.attr("disabled"),radio:!!g.attr("name"),value:g.val(),selected:!!g.attr("checked")};break;default:f=void 0}break;case "select":f={type:"select",name:l||a(p),disabled:!!g.attr("disabled"),selected:g.val(),options:{}};g.children().each(function(){f.options[this.value]=b(this).text()});break;case "textarea":f={type:"textarea",name:l||a(p),disabled:!!g.attr("disabled"),value:g.val()};
break;case "label":break;default:f={type:"html",html:g.clone(!0)}}f&&(c++,d["key"+c]=f)});return c}b.support.htmlMenuitem="HTMLMenuItemElement"in window;b.support.htmlCommand="HTMLCommandElement"in window;b.support.eventSelectstart="onselectstart"in document.documentElement;b.ui&&b.widget||(b.cleanData=function(a){return function(d){var g,p;for(p=0;null!=d[p];p++){var c=d[p];try{(g=b._data(c,"events"))&&g.remove&&b(c).triggerHandler("remove")}catch(x){}}a(d)}}(b.cleanData));var c=null,f=!1,k=b(window),
n=0,m={},d={},g={},l={selector:null,appendTo:null,trigger:"right",autoHide:!1,delay:200,reposition:!0,selectableSubMenu:!1,classNames:{hover:"context-menu-hover",disabled:"context-menu-disabled",visible:"context-menu-visible",notSelectable:"context-menu-not-selectable",icon:"context-menu-icon",iconEdit:"context-menu-icon-edit",iconCut:"context-menu-icon-cut",iconCopy:"context-menu-icon-copy",iconPaste:"context-menu-icon-paste",iconDelete:"context-menu-icon-delete",iconAdd:"context-menu-icon-add",
...
5};a.css(d)}},zIndex:1,animation:{duration:50,show:"slideDown",hide:"slideUp"},events:{show:b.noop,hide:b.noop},callback:null,items:{}},r=null,v=null,w=null,E,C=function(a){for(var b=0;b=Math.max(b,parseInt(a.css("z-index"),10)||0),a=a.parent(),a&&a.length&&!(-1<"html body".indexOf(a.prop("nodeName").toLowerCase())););return b},q={abortevent:function(a){a.preventDefault();a.stopImmediatePropagation()},contextmenu:function(a){var d=b(this);"right"===a.data.trigger&&(a.preventDefault(),a.stopImmediatePropagation());
if(!("right"!==a.data.trigger&&"demand"!==a.data.trigger&&a.originalEvent||"undefined"!==typeof a.mouseButton&&a.data&&!("left"===a.data.trigger&&0===a.mouseButton||"right"===a.data.trigger&&2===a.mouseButton)||d.hasClass("context-menu-active")||d.hasClass("context-menu-disabled"))){c=d;if(a.data.build){var g=a.data.build(c,a);if(!1===g)return;a.data=b.extend(!0,{},l,a.data,g||{});if(!a.data.items||b.isEmptyObject(a.data.items))throw window.console&&(console.error||console.log).call(console,"No items specified to show in contextMenu"),
Error("No Items specified");a.data.$trigger=c;t.create(a.data)}g=!1;for(var p in a.data.items)a.data.items.hasOwnProperty(p)&&(b.isFunction(a.data.items[p].visible)?a.data.items[p].visible.call(b(a.currentTarget),p,a.data):"undefined"!==typeof a.data.items[p]&&a.data.items[p].visible?!0===a.data.items[p].visible:1)&&(g=!0);g&&t.show.call(d,a.data,a.pageX,a.pageY)}},click:function(a){a.preventDefault();a.stopImmediatePropagation();b(this).trigger(b.Event("contextmenu",{data:a.data,pageX:a.pageX,pageY:a.pageY}))},
mousedown:function(a){var d=b(this);c&&c.length&&!c.is(d)&&c.data("contextMenu").$menu.trigger("contextmenu:hide");2===a.button&&(c=d.data("contextMenuActive",!0))},mouseup:function(a){var d=b(this);d.data("contextMenuActive")&&c&&c.length&&c.is(d)&&!d.hasClass("context-menu-disabled")&&(a.preventDefault(),a.stopImmediatePropagation(),c=d,d.trigger(b.Event("contextmenu",{data:a.data,pageX:a.pageX,pageY:a.pageY})));d.removeData("contextMenuActive")},mouseenter:function(a){var d=b(this),g=b(a.relatedTarget),
e=b(document);g.is(".context-menu-list")||g.closest(".context-menu-list").length||c&&c.length||(v=a.pageX,w=a.pageY,E=a.data,e.on("mousemove.contextMenuShow",q.mousemove),r=setTimeout(function(){r=null;e.off("mousemove.contextMenuShow");c=d;d.trigger(b.Event("contextmenu",{data:E,pageX:v,pageY:w}))},a.data.delay))},mousemove:function(a){v=a.pageX;w=a.pageY},mouseleave:function(a){a=b(a.relatedTarget);if(!a.is(".context-menu-list")&&!a.closest(".context-menu-list").length){try{clearTimeout(r)}catch(y){}r=
null}},layerClick:function(a){var d=b(this).data("contextMenuRoot"),g=a.button,c=a.pageX,e=a.pageY,l,p;a.preventDefault();setTimeout(function(){var y="left"===d.trigger&&0===g||"right"===d.trigger&&2===g;if(document.elementFromPoint&&d.$layer){d.$layer.hide();l=document.elementFromPoint(c-k.scrollLeft(),e-k.scrollTop());if(l.isContentEditable){var f=document.createRange();var B=window.getSelection();f.selectNode(l);f.collapse(!0);B.removeAllRanges();B.addRange(f)}b(l).trigger(a);d.$layer.show()}if(d.reposition&&
y)if(document.elementFromPoint){if(d.$trigger.is(l)){d.position.call(d.$trigger,d,c,e);return}}else if(p=d.$trigger.offset(),f=b(window),p.top+=f.scrollTop(),p.top<=a.pageY&&(p.left+=f.scrollLeft(),p.left<=a.pageX&&(p.bottom=p.top+d.$trigger.outerHeight(),p.bottom>=a.pageY&&(p.right=p.left+d.$trigger.outerWidth(),p.right>=a.pageX)))){d.position.call(d.$trigger,d,c,e);return}if(l&&y)d.$trigger.one("contextmenu:hidden",function(){b(l).contextMenu({x:c,y:e,button:g})});null!==d&&"undefined"!==typeof d&&
null!==d.$menu&&"undefined"!==typeof d.$menu&&d.$menu.trigger("contextmenu:hide")},50)},keyStop:function(a,d){d.isInput||a.preventDefault();a.stopPropagation()},key:function(a){var d={};c&&(d=c.data("contextMenu")||{});"undefined"===typeof d.zIndex&&(d.zIndex=0);var b=0,g=function(a){""!==a.style.zIndex?b=a.style.zIndex:null!==a.offsetParent&&"undefined"!==typeof a.offsetParent?g(a.offsetParent):null!==a.parentElement&&"undefined"!==typeof a.parentElement&&g(a.parentElement)};g(a.target);if(!(d.$menu&&
...
if(d.isInput||!d.$selected||!d.$selected.length)break;if(!d.$selected.parent().hasClass("context-menu-root")){a=d.$selected.parent().parent();d.$selected.trigger("contextmenu:blur");d.$selected=a;return}break;case 39:q.keyStop(a,d);if(d.isInput||!d.$selected||!d.$selected.length)break;var e=d.$selected.data("contextMenu")||{};if(e.$menu&&d.$selected.hasClass("context-menu-submenu")){d.$selected=null;e.$selected=null;e.$menu.trigger("nextcommand");return}break;case 35:case 36:d.$selected&&d.$selected.find("input, textarea, select").length||
...
d.$menu&&"undefined"!==typeof d.$menu&&d.$menu.trigger("contextmenu:hide");return;default:if(e=String.fromCharCode(a.keyCode).toUpperCase(),d.accesskeys&&d.accesskeys[e]){d.accesskeys[e].$node.trigger(d.accesskeys[e].$menu?"contextmenu:focus":"mouseup");return}}a.stopPropagation();"undefined"!==typeof d.$selected&&null!==d.$selected&&d.$selected.trigger(a)}},prevItem:function(a){a.stopPropagation();var d=b(this).data("contextMenu")||{},g=b(this).data("contextMenuRoot")||{};if(d.$selected){var c=d.$selected;
...
g.$node.addClass(d.classNames.hover),g.$node&&d.positionSubmenu.call(g.$node,g.$menu))},blurItem:function(a){a.stopPropagation();a=b(this);var d=a.data(),g=d.contextMenu;d=d.contextMenuRoot;g.autoHide&&a.removeClass(d.classNames.visible);a.removeClass(d.classNames.hover);g.$selected=null}},t={show:function(a,d,g){var e=b(this),l={};b("#context-menu-layer").trigger("mousedown");a.$trigger=e;if(!1===a.events.show.call(e,a))c=null;else if(t.update.call(e,a),a.position.call(e,a,d,g),a.zIndex&&(d=a.zIndex,
"function"===typeof a.zIndex&&(d=a.zIndex.call(e,a)),l.zIndex=C(e)+d),t.layer.call(a.$menu,a,l.zIndex),a.$menu.find("ul").css("zIndex",l.zIndex+1),a.$menu.css(l)[a.animation.show](a.animation.duration,function(){e.trigger("contextmenu:visible")}),e.data("contextMenu",a).addClass("context-menu-active"),b(document).off("keydown.contextMenu").on("keydown.contextMenu",q.key),a.autoHide)b(document).on("mousemove.contextMenuAutoHide",function(d){var b=e.offset();b.right=b.left+e.outerWidth();b.bottom=b.top+
e.outerHeight();!a.$layer||a.hovering||d.pageX>=b.left&&d.pageX<=b.right&&d.pageY>=b.top&&d.pageY<=b.bottom||setTimeout(function(){a.hovering||null===a.$menu||"undefined"===typeof a.$menu||a.$menu.trigger("contextmenu:hide")},50)})},hide:function(a,d){var g=b(this);a||(a=g.data("contextMenu")||{});if(d||!a.events||!1!==a.events.hide.call(g,a)){g.removeData("contextMenu").removeClass("context-menu-active");if(a.$layer){setTimeout(function(a){return function(){a.remove()}}(a.$layer),10);try{delete a.$layer}catch(D){a.$layer=
null}}c=null;a.$menu.find("."+a.classNames.hover).trigger("contextmenu:blur");a.$selected=null;a.$menu.find("."+a.classNames.visible).removeClass(a.classNames.visible);b(document).off(".contextMenuAutoHide").off("keydown.contextMenu");if(a.$menu)a.$menu[a.animation.hide](a.animation.duration,function(){a.build&&(a.$menu.remove(),b.each(a,function(d){switch(d){case "ns":case "selector":case "build":case "trigger":return!0;default:a[d]=void 0;try{delete a[d]}catch(B){}return!0}}));setTimeout(function(){g.trigger("contextmenu:hidden")},
...
return d}"undefined"===typeof d&&(d=a);a.$menu=b('<ul class="context-menu-list"></ul>').addClass(a.className||"").data({contextMenu:a,contextMenuRoot:d});b.each(["callbacks","commands","inputs"],function(b,g){a[g]={};d[g]||(d[g]={})});d.accesskeys||(d.accesskeys={});b.each(a.items,function(e,l){var f=b('<li class="context-menu-item"></li>').addClass(l.className||""),k=null,r=null;f.on("click",b.noop);if("string"===typeof l||"cm_separator"===l.type)l={type:"cm_seperator"};l.$node=f.data({contextMenu:a,
contextMenuRoot:d,contextMenuKey:e});if("undefined"!==typeof l.accesskey)for(var w=h(l.accesskey),p=0,v;v=w[p];p++)if(!d.accesskeys[v]){d.accesskeys[v]=l;if(w=l.name.match(new RegExp("^(.*?)("+v+")(.*)$","i")))l._beforeAccesskey=w[1],l._accesskey=w[2],l._afterAccesskey=w[3];break}if(l.type&&g[l.type])g[l.type].call(f,l,a,d),b.each([a,d],function(d,g){g.commands[e]=l;!b.isFunction(l.callback)||"undefined"!==typeof g.callbacks[e]&&"undefined"!==typeof a.type||(g.callbacks[e]=l.callback)});else{"cm_seperator"===
l.type?f.addClass("context-menu-separator "+d.classNames.notSelectable):"html"===l.type?f.addClass("context-menu-html "+d.classNames.notSelectable):"sub"!==l.type&&(l.type?(k=b("<label></label>").appendTo(f),c(l).appendTo(k),f.addClass("context-menu-input"),a.hasTypes=!0,b.each([a,d],function(a,d){d.commands[e]=l;d.inputs[e]=l})):l.items&&(l.type="sub"));switch(l.type){case "cm_seperator":break;case "text":r=b('<input type="text" value="1" name="" />').attr("name","context-menu-input-"+e).val(l.value||
...
break;case "select":r=b('<select name=""></select>').attr("name","context-menu-input-"+e).appendTo(k);l.options&&(b.each(l.options,function(a,d){b("<option></option>").val(a).text(d).appendTo(r)}),r.val(l.selected));break;case "sub":c(l).appendTo(f);l.appendTo=l.$node;f.data("contextMenu",l).addClass("context-menu-submenu");l.callback=null;"function"===typeof l.items.then?t.processPromises(l,d,l.items):t.create(l,d);break;case "html":b(l.html).appendTo(f);break;default:b.each([a,d],function(d,g){g.commands[e]=
l;!b.isFunction(l.callback)||"undefined"!==typeof g.callbacks[e]&&"undefined"!==typeof a.type||(g.callbacks[e]=l.callback)}),c(l).appendTo(f)}if(l.type&&"sub"!==l.type&&"html"!==l.type&&"cm_seperator"!==l.type&&(r.on("focus",q.focusInput).on("blur",q.blurInput),l.events))r.on(l.events,a);l.icon&&(b.isFunction(l.icon)?l._icon=l.icon.call(this,this,f,e,l):"string"===typeof l.icon&&"fa-"===l.icon.substring(0,3)?l._icon=d.classNames.icon+" "+d.classNames.icon+"--fa fa "+l.icon:l._icon=d.classNames.icon+
" "+d.classNames.icon+"-"+l.icon,f.addClass(l._icon))}l.$input=r;l.$label=k;f.appendTo(a.$menu);if(!a.hasTypes&&b.support.eventSelectstart)f.on("selectstart.disableTextSelect",q.abortevent)});a.$node||a.$menu.css("display","none").addClass("context-menu-root");a.$menu.appendTo(a.appendTo||document.body)},resize:function(a,d){var g;a.css({position:"absolute",display:"block"});a.data("width",(g=a.get(0)).getBoundingClientRect?Math.ceil(g.getBoundingClientRect().width):a.outerWidth()+1);a.css({position:"static",
minWidth:"0px",maxWidth:"100000px"});a.find("> li > ul").each(function(){t.resize(b(this),!0)});d||a.find("ul").addBack().css({position:"",display:"",minWidth:"",maxWidth:""}).outerWidth(function(){return b(this).data("width")})},update:function(a,d){var g=this;"undefined"===typeof d&&(d=a,t.resize(a.$menu));a.$menu.children().each(function(){var e=b(this),l=e.data("contextMenuKey"),c=a.items[l],f=b.isFunction(c.disabled)&&c.disabled.call(g,l,d)||!0===c.disabled;var k=b.isFunction(c.visible)?c.visible.call(g,
l,d):"undefined"!==typeof c.visible?!0===c.visible:!0;e[k?"show":"hide"]();e[f?"addClass":"removeClass"](d.classNames.disabled);b.isFunction(c.icon)&&(e.removeClass(c._icon),c._icon=c.icon.call(this,g,e,l,c),e.addClass(c._icon));if(c.type)switch(e.find("input, select, textarea").prop("disabled",f),c.type){case "text":case "textarea":c.$input.val(c.value||"");break;case "checkbox":case "radio":c.$input.val(c.value||"").prop("checked",!!c.selected);break;case "select":c.$input.val((0===c.selected?"0":
c.selected)||"")}c.$menu&&t.update.call(g,c,d)})},layer:function(a,d){a=a.$layer=b('<div id="context-menu-layer"></div>').css({height:k.height(),width:k.width(),display:"block",position:"fixed","z-index":d,top:0,left:0,opacity:0,filter:"alpha(opacity=0)","background-color":"#000"}).data("contextMenuRoot",a).insertBefore(this).on("contextmenu",q.abortevent).on("mousedown",q.layerClick);"undefined"===typeof document.body.style.maxWidth&&a.css({position:"absolute",height:b(document).height()});return a},
...
typeof a&&(g=a,a="create");"string"===typeof g?g={selector:g}:"undefined"===typeof g&&(g={});var c=b.extend(!0,{},l,g||{}),e=b(document),k=e,r=!1;c.context&&c.context.length?(k=b(c.context).first(),c.context=k.get(0),r=!b(c.context).is(document)):c.context=document;switch(a){case "create":if(!c.selector)throw Error("No selector specified");if(c.selector.match(/.context-menu-(list|item|input)($|\s)/))throw Error('Cannot bind to selector "'+c.selector+'" as it contains a reserved className');if(!c.build&&
(!c.items||b.isEmptyObject(c.items)))throw Error("No Items specified");n++;c.ns=".contextMenu"+n;r||(m[c.selector]=c.ns);d[c.ns]=c;c.trigger||(c.trigger="right");f||(a={"contextmenu:focus.contextMenu":q.focusItem,"contextmenu:blur.contextMenu":q.blurItem,"contextmenu.contextMenu":q.abortevent,"mouseenter.contextMenu":q.itemMouseenter,"mouseleave.contextMenu":q.itemMouseleave},a["click"===c.itemClickEvent?"click.contextMenu":"mouseup.contextMenu"]=q.itemClick,e.on({"contextmenu:hide.contextMenu":q.hideMenu,
"prevcommand.contextMenu":q.prevItem,"nextcommand.contextMenu":q.nextItem,"contextmenu.contextMenu":q.abortevent,"mouseenter.contextMenu":q.menuMouseenter,"mouseleave.contextMenu":q.menuMouseleave},".context-menu-list").on("mouseup.contextMenu",".context-menu-input",q.inputClick).on(a,".context-menu-item"),f=!0);k.on("contextmenu"+c.ns,c.selector,c,q.contextmenu);if(r)k.on("remove"+c.ns,function(){b(this).contextMenu("destroy")});switch(c.trigger){case "hover":k.on("mouseenter"+c.ns,c.selector,c,
q.mouseenter).on("mouseleave"+c.ns,c.selector,c,q.mouseleave);break;case "left":k.on("click"+c.ns,c.selector,c,q.click);break;case "touchstart":k.on("touchstart"+c.ns,c.selector,c,q.click)}c.build||t.create(c);break;case "destroy":if(r){var w=c.context;b.each(d,function(a,g){if(!g||!b(w).is(g.selector))return!0;h=b(".context-menu-list").filter(":visible");h.length&&h.data().contextMenuRoot.$trigger.is(b(g.context).find(g.selector))&&h.trigger("contextmenu:hide",{force:!0});try{d[g.ns].$menu&&d[g.ns].$menu.remove(),
delete d[g.ns]}catch(z){d[g.ns]=null}b(g.context).off(g.ns);return!0})}else if(!c.selector)e.off(".contextMenu .contextMenuAutoHide"),b.each(d,function(a,d){b(d.context).off(d.ns)}),m={},d={},n=0,f=!1,b("#context-menu-layer, .context-menu-list").remove();else if(m[c.selector]){var h=b(".context-menu-list").filter(":visible");h.length&&h.data().contextMenuRoot.$trigger.is(c.selector)&&h.trigger("contextmenu:hide",{force:!0});try{d[m[c.selector]].$menu&&d[m[c.selector]].$menu.remove(),delete d[m[c.selector]]}catch(K){d[m[c.selector]]=
null}e.off(m[c.selector])}break;case "html5":(!b.support.htmlCommand&&!b.support.htmlMenuitem||"boolean"===typeof g&&g)&&b('menu[type="context"]').each(function(){this.id&&b.contextMenu({selector:"[contextmenu="+this.id+"]",items:b.contextMenu.fromMenu(this)})}).css("display","none");break;default:throw Error('Unknown operation "'+a+'"');}return this};b.contextMenu.setInputValues=function(a,d){"undefined"===typeof d&&(d={});b.each(a.inputs,function(a,b){switch(b.type){case "text":case "textarea":b.value=
...
b(a);var d={};e(d,a.children());return d};b.contextMenu.defaults=l;b.contextMenu.types=g;b.contextMenu.handle=q;b.contextMenu.op=t;b.contextMenu.menus=d});jQuery.cookie=function(b,h,a){if("undefined"!=typeof h){a=a||{};null===h&&(h="",a.expires=-1);var e="";a.expires&&("number"==typeof a.expires||a.expires.toUTCString)&&("number"==typeof a.expires?(e=new Date,e.setTime(e.getTime()+864E5*a.expires)):e=a.expires,e="; expires="+e.toUTCString());var c=a.path?"; path="+a.path:"",f=a.domain?"; domain="+a.domain:"";a=a.secure?"; secure":"";document.cookie=[b,"=",encodeURIComponent(h),e,c,f,a].join("")}else{h=null;if(document.cookie&&""!=document.cookie)for(a=
document.cookie.split(";"),e=0;e<a.length;e++)if(c=jQuery.trim(a[e]),c.substring(0,b.length+1)==b+"="){h=decodeURIComponent(c.substring(b.length+1));break}return h}};var dia={exception:function(b){$("#modal-dynamicException .modal-title").html("Exception: "+b.string);$("#modal-dynamicException .modal-body").html(b.details);$("#modal-dynamicException").modal();console.log("Stack trace for "+b.string+":");console.log(b.trace)},error:function(b){console.log("Error: "+b);$("#modal-dynamicError .modal-body").html(b);$("#modal-dynamicError").modal()},info:function(b,h){$.notify({message:b},{type:h?h:"info",placement:{from:"top",align:"center"},delay:3E3})},confirm:function(b,
h){$("#modal-dynamicConfirm .modal-title").text(h);$("#modal-dynamicConfirm .modal-body").html(b.text);$("#modal-dynamicConfirm button[name=confirm]").off("click").on("click",function(){if("undefined"!==typeof b["true"])b["true"]();$("#modal-dynamicConfirm").modal("hide")});$("#modal-dynamicConfirm button[name=cancel]").off("click").on("click",function(){if("undefined"!==typeof b["false"])b["false"]();$("#modal-dynamicConfirm").modal("hide")});$("#modal-dynamicConfirm").modal()},full:function(b){$("#modal-dynamicFull .modal-title").text(b.title);
$("#modal-dynamicFull .modal-body").html(b.content);$("#modal-dynamicFull").modal();$("#modal-dynamicFull .modal-footer").html("");jQuery.each(b.buttons,function(b,a){$("#modal-dynamicFull .modal-footer").append($("<button>").attr("class","btn btn-secondary").text(b).click(function(){a();$("#modal-dynamicFull").modal("hide");return!1}))});"undefined"!==typeof b.oF&&b.oF();if("undefined"!==typeof b.cF)$("#modal-dynamicFull").on("hidden.bs.modal",function(){b.cF()})}};(function(b){"function"===typeof define&&define.amd?define(["jquery","jquery-ui/ui/widget"],b):"object"===typeof exports?b(require("jquery"),require("./vendor/jquery.ui.widget")):b(window.jQuery)})(function(b){function h(a){var e="dragover"===a;return function(c){c.dataTransfer=c.originalEvent&&c.originalEvent.dataTransfer;var f=c.dataTransfer;f&&-1!==b.inArray("Files",f.types)&&!1!==this._trigger(a,b.Event(a,{delegatedEvent:c}))&&(c.preventDefault(),e&&(f.dropEffect="copy"))}}b.support.fileInput=
...
i18n:function(a,e){a=this.messages[a]||a.toString();e&&b.each(e,function(b,e){a=a.replace("{"+b+"}",e)});return a},formData:function(a){return a.serializeArray()},add:function(a,e){if(a.isDefaultPrevented())return!1;(e.autoUpload||!1!==e.autoUpload&&b(this).fileupload("option","autoUpload"))&&e.process().done(function(){e.submit()})},processData:!1,contentType:!1,cache:!1,timeout:0},_specialOptions:["fileInput","dropZone","pasteZone","multipart","forceIframeTransport"],_blobSlice:b.support.blobSlice&&
...
b.type(a.formData))return a.formData(a.form);if(b.isArray(a.formData))return a.formData;if("object"===b.type(a.formData)){var e=[];b.each(a.formData,function(a,b){e.push({name:a,value:b})});return e}return[]},_getTotal:function(a){var e=0;b.each(a,function(a,b){e+=b.size||1});return e},_initProgressObject:function(a){var e={loaded:0,total:0,bitrate:0};a._progress?b.extend(a._progress,e):a._progress=e},_initResponseObject:function(a){var b;if(a._response)for(b in a._response)a._response.hasOwnProperty(b)&&
delete a._response[b];else a._response={}},_onProgress:function(a,e){if(a.lengthComputable){var c=Date.now?Date.now():(new Date).getTime();if(!(e._time&&e.progressInterval&&c-e._time<e.progressInterval&&a.loaded!==a.total)){e._time=c;var f=Math.floor(a.loaded/a.total*(e.chunkSize||e._progress.total))+(e.uploadedBytes||0);this._progress.loaded+=f-e._progress.loaded;this._progress.bitrate=this._bitrateTimer.getBitrate(c,this._progress.loaded,e.bitrateInterval);e._progress.loaded=e.loaded=f;e._progress.bitrate=
e.bitrate=e._bitrateTimer.getBitrate(c,f,e.bitrateInterval);this._trigger("progress",b.Event("progress",{delegatedEvent:a}),e);this._trigger("progressall",b.Event("progressall",{delegatedEvent:a}),this._progress)}}},_initProgressListener:function(a){var e=this,c=a.xhr?a.xhr():b.ajaxSettings.xhr();c.upload&&(b(c.upload).bind("progress",function(b){var c=b.originalEvent;b.lengthComputable=c.lengthComputable;b.loaded=c.loaded;b.total=c.total;e._onProgress(b,a)}),a.xhr=function(){return c})},_isInstanceOf:function(a,
b){return Object.prototype.toString.call(b)==="[object "+a+"]"},_initXHRData:function(a){var e=this,c=a.files[0],f=a.multipart||!b.support.xhrFileUpload,k="array"===b.type(a.paramName)?a.paramName[0]:a.paramName;a.headers=b.extend({},a.headers);a.contentRange&&(a.headers["Content-Range"]=a.contentRange);f&&!a.blob&&this._isInstanceOf("File",c)||(a.headers["Content-Disposition"]='attachment; filename="'+encodeURI(c.name)+'"');if(!f)a.contentType=c.type||"application/octet-stream",a.data=a.blob||c;
else if(b.support.xhrFormDataFileUpload){if(a.postMessage){var h=this._getFormData(a);a.blob?h.push({name:k,value:a.blob}):b.each(a.files,function(c,d){h.push({name:"array"===b.type(a.paramName)&&a.paramName[c]||k,value:d})})}else e._isInstanceOf("FormData",a.formData)?h=a.formData:(h=new FormData,b.each(this._getFormData(a),function(a,d){h.append(d.name,d.value)})),a.blob?h.append(k,a.blob,c.name):b.each(a.files,function(c,d){(e._isInstanceOf("File",d)||e._isInstanceOf("Blob",d))&&h.append("array"===
b.type(a.paramName)&&a.paramName[c]||k,d,d.uploadName||d.name)});a.data=h}a.blob=null},_initIframeSettings:function(a){var e=b("<a></a>").prop("href",a.url).prop("host");a.dataType="iframe "+(a.dataType||"");a.formData=this._getFormData(a);a.redirect&&e&&e!==location.host&&a.formData.push({name:a.redirectParamName||"redirect",value:a.redirect})},_initDataSettings:function(a){this._isXHRUpload(a)?(this._chunkedUpload(a,!0)||(a.data||this._initXHRData(a),this._initProgressListener(a)),a.postMessage&&
(a.dataType="postmessage "+(a.dataType||""))):this._initIframeSettings(a)},_getParamName:function(a){var e=b(a.fileInput),c=a.paramName;c?b.isArray(c)||(c=[c]):(c=[],e.each(function(){var a=b(this),e=a.prop("name")||"files[]";for(a=(a.prop("files")||[1]).length;a;)c.push(e),--a}),c.length||(c=[e.prop("name")||"files[]"]));return c},_initFormSettings:function(a){a.form&&a.form.length||(a.form=b(a.fileInput.prop("form")),a.form.length||(a.form=b(this.options.fileInput.prop("form"))));a.paramName=this._getParamName(a);
...
"rejected":"pending"},_enhancePromise:function(a){a.success=a.done;a.error=a.fail;a.complete=a.always;return a},_getXHRPromise:function(a,e,c){var f=b.Deferred(),k=f.promise();e=e||this.options.context||k;!0===a?f.resolveWith(e,c):!1===a&&f.rejectWith(e,c);k.abort=f.promise;return this._enhancePromise(k)},_addConvenienceMethods:function(a,e){var c=this,f=function(a){return b.Deferred().resolveWith(c,a).promise()};e.process=function(a,h){if(a||h)e._processQueue=this._processQueue=(this._processQueue||
f([this])).then(function(){return e.errorThrown?b.Deferred().rejectWith(c,[e]).promise():f(arguments)}).then(a,h);return this._processQueue||f([this])};e.submit=function(){"pending"!==this.state()&&(e.jqXHR=this.jqXHR=!1!==c._trigger("submit",b.Event("submit",{delegatedEvent:a}),this)&&c._onSend(a,this));return this.jqXHR||c._getXHRPromise()};e.abort=function(){if(this.jqXHR)return this.jqXHR.abort();this.errorThrown="abort";c._trigger("fail",null,this);return c._getXHRPromise(!1)};e.state=function(){if(this.jqXHR)return c._getDeferredState(this.jqXHR);
if(this._processQueue)return c._getDeferredState(this._processQueue)};e.processing=function(){return!this.jqXHR&&this._processQueue&&"pending"===c._getDeferredState(this._processQueue)};e.progress=function(){return this._progress};e.response=function(){return this._response}},_getUploadedBytes:function(a){return(a=(a=(a=a.getResponseHeader("Range"))&&a.split("-"))&&1<a.length&&parseInt(a[1],10))&&a+1},_chunkedUpload:function(a,e){a.uploadedBytes=a.uploadedBytes||0;var c=this,f=a.files[0],k=f.size,
h=a.uploadedBytes,m=a.maxChunkSize||k,d=this._blobSlice,g=b.Deferred(),l=g.promise(),r;if(!(this._isXHRUpload(a)&&d&&(h||("function"===b.type(m)?m(a):m)<k))||a.data)return!1;if(e)return!0;if(h>=k)return f.error=a.i18n("uploadedBytes"),this._getXHRPromise(!1,a.context,[null,"error",f.error]);var v=function(){var e=b.extend({},a),l=e._progress.loaded;e.blob=d.call(f,h,h+("function"===b.type(m)?m(e):m),f.type);e.chunkSize=e.blob.size;e.contentRange="bytes "+h+"-"+(h+e.chunkSize-1)+"/"+k;c._initXHRData(e);
c._initProgressListener(e);r=(!1!==c._trigger("chunksend",null,e)&&b.ajax(e)||c._getXHRPromise(!1,e.context)).done(function(d,f,r){h=c._getUploadedBytes(r)||h+e.chunkSize;l+e.chunkSize-e._progress.loaded&&c._onProgress(b.Event("progress",{lengthComputable:!0,loaded:h-e.uploadedBytes,total:h-e.uploadedBytes}),e);a.uploadedBytes=e.uploadedBytes=h;e.result=d;e.textStatus=f;e.jqXHR=r;c._trigger("chunkdone",null,e);c._trigger("chunkalways",null,e);h<k?v():g.resolveWith(e.context,[d,f,r])}).fail(function(a,
d,b){e.jqXHR=a;e.textStatus=d;e.errorThrown=b;c._trigger("chunkfail",null,e);c._trigger("chunkalways",null,e);g.rejectWith(e.context,[a,d,b])})};this._enhancePromise(l);l.abort=function(){return r.abort()};v();return l},_beforeSend:function(a,b){0===this._active&&(this._trigger("start"),this._bitrateTimer=new this._BitrateTimer,this._progress.loaded=this._progress.total=0,this._progress.bitrate=0);this._initResponseObject(b);this._initProgressObject(b);b._progress.loaded=b.loaded=b.uploadedBytes||
0;b._progress.total=b.total=this._getTotal(b.files)||1;b._progress.bitrate=b.bitrate=0;this._active+=1;this._progress.loaded+=b.loaded;this._progress.total+=b.total},_onDone:function(a,e,c,f){var k=f._progress.total,h=f._response;f._progress.loaded<k&&this._onProgress(b.Event("progress",{lengthComputable:!0,loaded:k,total:k}),f);h.result=f.result=a;h.textStatus=f.textStatus=e;h.jqXHR=f.jqXHR=c;this._trigger("done",null,f)},_onFail:function(a,b,c,f){var e=f._response;f.recalculateProgress&&(this._progress.loaded-=
f._progress.loaded,this._progress.total-=f._progress.total);e.jqXHR=f.jqXHR=a;e.textStatus=f.textStatus=b;e.errorThrown=f.errorThrown=c;this._trigger("fail",null,f)},_onAlways:function(a,b,c,f){this._trigger("always",null,f)},_onSend:function(a,e){e.submit||this._addConvenienceMethods(a,e);var c=this,f,k,h=c._getAJAXSettings(e),m=function(){c._sending+=1;h._bitrateTimer=new c._BitrateTimer;return f=f||((k||!1===c._trigger("send",b.Event("send",{delegatedEvent:a}),h))&&c._getXHRPromise(!1,h.context,
k)||c._chunkedUpload(h)||b.ajax(h)).done(function(a,d,b){c._onDone(a,d,b,h)}).fail(function(a,d,b){c._onFail(a,d,b,h)}).always(function(a,d,b){c._onAlways(a,d,b,h);--c._sending;--c._active;if(h.limitConcurrentUploads&&h.limitConcurrentUploads>c._sending)for(a=c._slots.shift();a;){if("pending"===c._getDeferredState(a)){a.resolve();break}a=c._slots.shift()}0===c._active&&c._trigger("stop")})};this._beforeSend(a,h);if(this.options.sequentialUploads||this.options.limitConcurrentUploads&&this.options.limitConcurrentUploads<=
this._sending){if(1<this.options.limitConcurrentUploads){var d=b.Deferred();this._slots.push(d);e=d.then(m)}else e=this._sequence=this._sequence.then(m,m);e.abort=function(){k=[void 0,"abort","abort"];return f?f.abort():(d&&d.rejectWith(h.context,k),m())};return this._enhancePromise(e)}return m()},_onAdd:function(a,e){var c=this,f=!0,h=b.extend({},this.options,e),n=e.files,m=n.length,d=h.limitMultiFileUploads,g=h.limitMultiFileUploadSize,l=h.limitMultiFileUploadSizeOverhead,r=0,v=this._getParamName(h),
w=0;if(!m)return!1;g&&void 0===n[0].size&&(g=void 0);if((h.singleFileUploads||d||g)&&this._isXHRUpload(h))if(h.singleFileUploads||g||!d)if(!h.singleFileUploads&&g){var E=[];var C=[];for(h=0;h<m;h+=1)if(r+=n[h].size+l,h+1===m||r+n[h+1].size+l>g||d&&h+1-w>=d)E.push(n.slice(w,h+1)),r=v.slice(w,h+1),r.length||(r=v),C.push(r),w=h+1,r=0}else C=v;else for(E=[],C=[],h=0;h<m;h+=d)E.push(n.slice(h,h+d)),r=v.slice(h,h+d),r.length||(r=v),C.push(r);else E=[n],C=[v];e.originalFiles=n;b.each(E||n,function(d,g){var l=
b.extend({},e);l.files=E?g:[g];l.paramName=C[d];c._initResponseObject(l);c._initProgressObject(l);c._addConvenienceMethods(a,l);return f=c._trigger("add",b.Event("add",{delegatedEvent:a}),l)});return f},_replaceFileInput:function(a){var e=a.fileInput,c=e.clone(!0),f=e.is(document.activeElement);a.fileInputClone=c;b("<form></form>").append(c)[0].reset();e.after(c).detach();f&&c.focus();b.cleanData(e.unbind("remove"));this.options.fileInput=this.options.fileInput.map(function(a,b){return b===e[0]?c[0]:
b});e[0]===this.element[0]&&(this.element=c)},_handleFileTreeEntry:function(a,e){var c=this,f=b.Deferred(),h=[],n=function(d){d&&!d.entry&&(d.entry=a);f.resolve([d])},m=function(d){c._handleFileTreeEntries(d,e+a.name+"/").done(function(a){f.resolve(a)}).fail(n)},d=function(){g.readEntries(function(a){a.length?(h=h.concat(a),d()):m(h)},n)};e=e||"";if(a.isFile)a._file?(a._file.relativePath=e,f.resolve(a._file)):a.file(function(a){a.relativePath=e;f.resolve(a)},n);else if(a.isDirectory){var g=a.createReader();
d()}else f.resolve([]);return f.promise()},_handleFileTreeEntries:function(a,e){var c=this;return b.when.apply(b,b.map(a,function(a){return c._handleFileTreeEntry(a,e)})).then(function(){return Array.prototype.concat.apply([],arguments)})},_getDroppedFiles:function(a){a=a||{};var e=a.items;return e&&e.length&&(e[0].webkitGetAsEntry||e[0].getAsEntry)?this._handleFileTreeEntries(b.map(e,function(a){var b;if(a.webkitGetAsEntry){if(b=a.webkitGetAsEntry())b._file=a.getAsFile();return b}return a.getAsEntry()})):
b.Deferred().resolve(b.makeArray(a.files)).promise()},_getSingleFileInputFiles:function(a){a=b(a);var e=a.prop("webkitEntries")||a.prop("entries");if(e&&e.length)return this._handleFileTreeEntries(e);e=b.makeArray(a.prop("files"));if(e.length)void 0===e[0].name&&e[0].fileName&&b.each(e,function(a,b){b.name=b.fileName;b.size=b.fileSize});else{a=a.prop("value");if(!a)return b.Deferred().resolve([]).promise();e=[{name:a.replace(/^.*\\/,"")}]}return b.Deferred().resolve(e).promise()},_getFileInputFiles:function(a){return a instanceof
b&&1!==a.length?b.when.apply(b,b.map(a,this._getSingleFileInputFiles)).then(function(){return Array.prototype.concat.apply([],arguments)}):this._getSingleFileInputFiles(a)},_onChange:function(a){var e=this,c={fileInput:b(a.target),form:b(a.target.form)};this._getFileInputFiles(c.fileInput).always(function(h){c.files=h;e.options.replaceFileInput&&e._replaceFileInput(c);!1!==e._trigger("change",b.Event("change",{delegatedEvent:a}),c)&&e._onAdd(a,c)})},_onPaste:function(a){var e=a.originalEvent&&a.originalEvent.clipboardData&&
a.originalEvent.clipboardData.items,c={files:[]};e&&e.length&&(b.each(e,function(a,b){(a=b.getAsFile&&b.getAsFile())&&c.files.push(a)}),!1!==this._trigger("paste",b.Event("paste",{delegatedEvent:a}),c)&&this._onAdd(a,c))},_onDrop:function(a){a.dataTransfer=a.originalEvent&&a.originalEvent.dataTransfer;var e=this,c=a.dataTransfer,h={};c&&c.files&&c.files.length&&(a.preventDefault(),this._getDroppedFiles(c).always(function(c){h.files=c;!1!==e._trigger("drop",b.Event("drop",{delegatedEvent:a}),h)&&e._onAdd(a,
h)}))},_onDragOver:h("dragover"),_onDragEnter:h("dragenter"),_onDragLeave:h("dragleave"),_initEventHandlers:function(){this._isXHRUpload(this.options)&&(this._on(this.options.dropZone,{dragover:this._onDragOver,drop:this._onDrop,dragenter:this._onDragEnter,dragleave:this._onDragLeave}),this._on(this.options.pasteZone,{paste:this._onPaste}));b.support.fileInput&&this._on(this.options.fileInput,{change:this._onChange})},_destroyEventHandlers:function(){this._off(this.options.dropZone,"dragenter dragleave dragover drop");
this._off(this.options.pasteZone,"paste");this._off(this.options.fileInput,"change")},_destroy:function(){this._destroyEventHandlers()},_setOption:function(a,e){var c=-1!==b.inArray(a,this._specialOptions);c&&this._destroyEventHandlers();this._super(a,e);c&&(this._initSpecialOptions(),this._initEventHandlers())},_initSpecialOptions:function(){var a=this.options;void 0===a.fileInput?a.fileInput=this.element.is('input[type="file"]')?this.element:this.element.find('input[type="file"]'):a.fileInput instanceof
b||(a.fileInput=b(a.fileInput));a.dropZone instanceof b||(a.dropZone=b(a.dropZone));a.pasteZone instanceof b||(a.pasteZone=b(a.pasteZone))},_getRegExp:function(a){a=a.split("/");var b=a.pop();a.shift();return new RegExp(a.join("/"),b)},_isRegExpOption:function(a,e){return"url"!==a&&"string"===b.type(e)&&/^\/.*\/[igm]{0,3}$/.test(e)},_initDataAttributes:function(){var a=this,e=this.options,c=this.element.data();b.each(this.element[0].attributes,function(b,h){b=h.name.toLowerCase();/^data-/.test(b)&&
(b=b.slice(5).replace(/-[a-z]/g,function(a){return a.charAt(1).toUpperCase()}),h=c[b],a._isRegExpOption(b,h)&&(h=a._getRegExp(h)),e[b]=h)})},_create:function(){this._initDataAttributes();this._initSpecialOptions();this._slots=[];this._sequence=this._getXHRPromise(!0);this._sending=this._active=0;this._initProgressObject(this);this._initEventHandlers()},active:function(){return this._active},progress:function(){return this._progress},add:function(a){var e=this;a&&!this.options.disabled&&(a.fileInput&&
!a.files?this._getFileInputFiles(a.fileInput).always(function(b){a.files=b;e._onAdd(null,a)}):(a.files=b.makeArray(a.files),this._onAdd(null,a)))},send:function(a){if(a&&!this.options.disabled){if(a.fileInput&&!a.files){var e=this,c=b.Deferred(),h=c.promise(),k,n;h.abort=function(){n=!0;if(k)return k.abort();c.reject(null,"abort","abort");return h};this._getFileInputFiles(a.fileInput).always(function(b){n||(b.length?(a.files=b,k=e._onSend(null,a),k.then(function(a,b,e){c.resolve(a,b,e)},function(a,
b,e){c.reject(a,b,e)})):c.reject())});return this._enhancePromise(h)}a.files=b.makeArray(a.files);if(a.files.length)return this._onSend(null,a)}return this._getXHRPromise(!1,a&&a.context)}})});/*
...
*/
(function(b,h,a){function e(a){a=a||location.href;return"#"+a.replace(/^[^#]*#?(.*)$/,"$1")}"$:nomunge";var c=document,f=b.event.special,k=c.documentMode,n="onhashchange"in h&&(k===a||7<k);b.fn.hashchange=function(a){return a?this.bind("hashchange",a):this.trigger("hashchange")};b.fn.hashchange.delay=50;f.hashchange=b.extend(f.hashchange,{setup:function(){if(n)return!1;b(m.start)},teardown:function(){if(n)return!1;b(m.stop)}});var m=function(){function d(){var a=e(),g=m(f);a!==f?(w(f=a,g),b(h).trigger("hashchange")):
g!==f&&(location.href=location.href.replace(/#.*/,"")+g);l=setTimeout(d,b.fn.hashchange.delay)}var g={},l,f=e(),k=function(a){return a},w=k,m=k;g.start=function(){l||d()};g.stop=function(){l&&clearTimeout(l);l=a};navigator.userAgent.match(/msie [6,7,8]/i)&&!n&&function(){var a,l;g.start=function(){a||(l=(l=b.fn.hashchange.src)&&l+e(),a=b('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){l||w(e());d()}).attr("src",l||"javascript:0").insertAfter("body")[0].contentWindow,c.onpropertychange=
function(){try{"title"===event.propertyName&&(a.document.title=c.title)}catch(t){}})};g.stop=k;m=function(){return e(a.location.href)};w=function(d,g){var e=a.document,l=b.fn.hashchange.domain;d!==g&&(e.title=c.title,e.open(),l&&e.write('<script>document.domain="'+l+'"\x3c/script>'),e.close(),a.location.hash=d)}}();return g}()})(jQuery,this);var notify={webkitNotifySupported:function(){return"Notification"in window&&!(window.chrome&&!window.isSecureContext)},pushNotifySupported:function(){return"Notification"in window&&"serviceWorker"in navigator&&window.isSecureContext},webkitNotifyRequest:function(){window.Notification.requestPermission()},webkitNotify:function(b,h,a){"granted"!=window.Notification.permission?notify.webkitNotifyRequest():new window.Notification(h,{body:a,icon:b,tag:"fm-notify"})}};/*
...
*/
(function(b){if("function"===typeof define&&define.amd)define(["jquery"],b);else if("object"===typeof exports){var h=require("jquery");module.exports=b(h)}else b(window.jQuery||window.Zepto||window.$)})(function(b){b.fn.serializeJSON=function(h){var a,e,c,f,k,n,m,d;var g=b.serializeJSON;var l=this;var r=g.setupOpts(h);h=l.serializeArray();g.readCheckboxUncheckedValues(h,r,l);var v={};b.each(h,function(b,h){a=h.name;e=h.value;f=g.extractTypeAndNameWithNoType(a);k=f.nameWithNoType;(n=f.type)||(n=g.attrFromInputWithName(l,
a,"data-value-type"));g.validateType(a,n,r);"skip"!==n&&(m=g.splitInputNameIntoKeysArray(k),c=g.parseValue(e,a,n,r),(d=!c&&g.shouldSkipFalsy(l,a,k,n,r))||g.deepSet(v,m,c,r))});return v};b.serializeJSON={defaultOptions:{checkboxUncheckedValue:void 0,parseNumbers:!1,parseBooleans:!1,parseNulls:!1,parseAll:!1,parseWithFunction:null,skipFalsyValuesForTypes:[],skipFalsyValuesForFields:[],customTypes:{},defaultTypes:{string:function(b){return String(b)},number:function(b){return Number(b)},"boolean":function(b){return-1===
["false","null","undefined","","0"].indexOf(b)},"null":function(b){return-1===["false","null","undefined","","0"].indexOf(b)?b:null},array:function(b){return JSON.parse(b)},object:function(b){return JSON.parse(b)},auto:function(h){return b.serializeJSON.parseValue(h,null,null,{parseNumbers:!0,parseBooleans:!0,parseNulls:!0})},skip:null},useIntKeysAsArrayIndex:!1},setupOpts:function(h){var a=b.serializeJSON;null==h&&(h={});var e=a.defaultOptions||{};a="checkboxUncheckedValue parseNumbers parseBooleans parseNulls parseAll parseWithFunction skipFalsyValuesForTypes skipFalsyValuesForFields customTypes defaultTypes useIntKeysAsArrayIndex".split(" ");
for(c in h)if(-1===a.indexOf(c))throw Error("serializeJSON ERROR: invalid option '"+c+"'. Please use one of "+a.join(", "));var c=function(a){return!1!==h[a]&&""!==h[a]&&(h[a]||e[a])};a=c("parseAll");return{checkboxUncheckedValue:c("checkboxUncheckedValue"),parseNumbers:a||c("parseNumbers"),parseBooleans:a||c("parseBooleans"),parseNulls:a||c("parseNulls"),parseWithFunction:c("parseWithFunction"),skipFalsyValuesForTypes:c("skipFalsyValuesForTypes"),skipFalsyValuesForFields:c("skipFalsyValuesForFields"),
typeFunctions:b.extend({},c("defaultTypes"),c("customTypes")),useIntKeysAsArrayIndex:c("useIntKeysAsArrayIndex")}},parseValue:function(h,a,e,c){var f=b.serializeJSON;var k=h;c.typeFunctions&&e&&c.typeFunctions[e]?k=c.typeFunctions[e](h):c.parseNumbers&&f.isNumeric(h)?k=Number(h):!c.parseBooleans||"true"!==h&&"false"!==h?c.parseNulls&&"null"==h?k=null:c.typeFunctions&&c.typeFunctions.string&&(k=c.typeFunctions.string(h)):k="true"===h;c.parseWithFunction&&!e&&(k=c.parseWithFunction(k,a));return k},
isObject:function(b){return b===Object(b)},isUndefined:function(b){return void 0===b},isValidArrayIndex:function(b){return/^[0-9]+$/.test(String(b))},isNumeric:function(b){return 0<=b-parseFloat(b)},optionKeys:function(b){if(Object.keys)return Object.keys(b);var a,e=[];for(a in b)e.push(a);return e},readCheckboxUncheckedValues:function(h,a,e){var c,f;null==a&&(a={});e.find("input[type=checkbox][name]:not(:checked):not([disabled])").add(e.filter("input[type=checkbox][name]:not(:checked):not([disabled])")).each(function(e,
n){c=b(n);f=c.attr("data-unchecked-value");null==f&&(f=a.checkboxUncheckedValue);if(null!=f){if(n.name&&-1!==n.name.indexOf("[]["))throw Error("serializeJSON ERROR: checkbox unchecked values are not supported on nested arrays of objects like '"+n.name+"'. See https://github.com/marioizquierdo/jquery.serializeJSON/issues/67");h.push({name:n.name,value:f})}})},extractTypeAndNameWithNoType:function(b){var a;return(a=b.match(/(.*):([^:]+)$/))?{nameWithNoType:a[1],type:a[2]}:{nameWithNoType:b,type:null}},
shouldSkipFalsy:function(h,a,e,c,f){h=b.serializeJSON.attrFromInputWithName(h,a,"data-skip-falsy");if(null!=h)return"false"!==h;if((h=f.skipFalsyValuesForFields)&&(-1!==h.indexOf(e)||-1!==h.indexOf(a)))return!0;a=f.skipFalsyValuesForTypes;null==c&&(c="string");return a&&-1!==a.indexOf(c)?!0:!1},attrFromInputWithName:function(b,a,e){a='[name="'+a.replace(/(:|\.|\[|\]|\s)/g,"\\$1")+'"]';return b.find(a).add(b.filter(a)).attr(e)},validateType:function(h,a,e){var c=b.serializeJSON;e=c.optionKeys(e?e.typeFunctions:
c.defaultOptions.defaultTypes);if(a&&-1===e.indexOf(a))throw Error("serializeJSON ERROR: Invalid type "+a+" found in input name '"+h+"', please use one of "+e.join(", "));return!0},splitInputNameIntoKeysArray:function(h){h=h.split("[");h=b.map(h,function(a){return a.replace(/\]/g,"")});""===h[0]&&h.shift();return h},deepSet:function(h,a,e,c){null==c&&(c={});var f=b.serializeJSON;if(f.isUndefined(h))throw Error("ArgumentError: param 'o' expected to be an object or array, found undefined");if(!a||0===
a.length)throw Error("ArgumentError: param 'keys' expected to be an array with least one element");var k=a[0];if(1===a.length)""===k?h.push(e):h[k]=e;else{var n=a[1];if(""===k){k=h.length-1;var m=h[k];k=f.isObject(m)&&(f.isUndefined(m[n])||2<a.length)?k:k+1}if(""===n){if(f.isUndefined(h[k])||!b.isArray(h[k]))h[k]=[]}else if(c.useIntKeysAsArrayIndex&&f.isValidArrayIndex(n)){if(f.isUndefined(h[k])||!b.isArray(h[k]))h[k]=[]}else if(f.isUndefined(h[k])||!f.isObject(h[k]))h[k]={};a=a.slice(1);f.deepSet(h[k],
a,e,c)}}}});/*
 jQuery Typeahead
...
*/
(function(b){"function"===typeof define&&define.amd?define("jquery-typeahead",["jquery"],function(h){return b(h)}):"object"===typeof module&&module.exports?module.exports=function(h,a){void 0===h&&(h="undefined"!==typeof window?require("jquery"):require("jquery")(a));return b(h)}():b(jQuery)})(function(b){window.Typeahead={version:"2.10.4"};var h={input:null,minLength:2,maxLength:!1,maxItem:8,dynamic:!1,delay:300,order:null,offset:!1,hint:!1,accent:!1,highlight:!0,multiselect:null,group:!1,groupOrder:null,
...
this.source[a]||this.generateGroups.push(a))},generateSource:function(a){this.filterGenerateSource();if(Array.isArray(a)&&a.length)this.generateGroups=a;else if(!this.generateGroups.length){this.node.trigger("search"+this.namespace);return}this.requestGroups=[];this.generatedGroupCount=0;this.options.loadingAnimation&&this.container.addClass("loading");if(!this.helper.isEmpty(this.xhr)){for(var d in this.xhr)this.xhr.hasOwnProperty(d)&&this.xhr[d].abort();this.xhr={}}var c=this,e;d=0;for(var h=this.generateGroups.length;d<
h;++d){a=this.generateGroups[d];var f=this.options.source[a];var k=f.cache;var n=f.compression;if(k&&(e=window[k].getItem("TYPEAHEAD_"+this.selector+":"+a))){n&&(e=LZString.decompressFromUTF16(e));n=!1;try{e=JSON.parse(e+""),e.data&&e.ttl>(new Date).getTime()?(this.populateSource(e.data,a),n=!0,this.options.debug&&(m.log({node:this.selector,function:"generateSource()",message:'Source for group "'+a+'" found in '+k}),m.print())):window[k].removeItem("TYPEAHEAD_"+this.selector+":"+a)}catch(t){}if(n)continue}if(f.data&&
!f.ajax)if("function"===typeof f.data){var q=f.data.call(this);Array.isArray(q)?c.populateSource(q,a):"function"===typeof q.promise&&function(a){b.when(q).then(function(b){b&&Array.isArray(b)&&c.populateSource(b,a)})}(a)}else this.populateSource(b.extend(!0,[],f.data),a);else f.ajax&&(this.requests[a]||(this.requests[a]=this.generateRequestObject(a)),this.requestGroups.push(a))}this.requestGroups.length&&this.handleRequests();return!!this.generateGroups.length},generateRequestObject:function(a){var b=
this,d=this.options.source[a],c={request:{url:d.ajax.url||null,dataType:"json",beforeSend:function(g,c){b.xhr[a]=g;var e=b.requests[a].callback.beforeSend||d.ajax.beforeSend;"function"===typeof e&&e.apply(null,arguments)}},callback:{beforeSend:null,done:null,fail:null,then:null,always:null},extra:{path:d.ajax.path||null,group:a},validForGroup:[a]};if("function"!==typeof d.ajax&&(d.ajax instanceof Object&&(c=this.extendXhrObject(c,d.ajax)),1<Object.keys(this.options.source).length))for(var e in this.requests)this.requests.hasOwnProperty(e)&&
!this.requests[e].isDuplicated&&c.request.url&&c.request.url===this.requests[e].request.url&&(this.requests[e].validForGroup.push(a),c.isDuplicated=!0,delete c.validForGroup);return c},extendXhrObject:function(a,g){"object"===typeof g.callback&&(a.callback=g.callback,delete g.callback);"function"===typeof g.beforeSend&&(a.callback.beforeSend=g.beforeSend,delete g.beforeSend);a.request=b.extend(!0,a.request,g);"jsonp"!==a.request.dataType.toLowerCase()||a.request.jsonpCallback||(a.request.jsonpCallback=
"callback_"+a.extra.group);return a},handleRequests:function(){var a=this,g=this.requestGroups.length;if(!1!==this.helper.executeCallback.call(this,this.options.callback.onSendRequest,[this.node,this.query]))for(var c=0,e=this.requestGroups.length;c<e;++c){var h=this.requestGroups[c];this.requests[h].isDuplicated||function(d,c){if("function"===typeof a.options.source[d].ajax){var e=a.options.source[d].ajax.call(a,a.query);c=a.extendXhrObject(a.generateRequestObject(d),"object"===typeof e?e:{});if("object"!==
typeof c.request||!c.request.url){a.options.debug&&(m.log({node:a.selector,function:"handleRequests",message:'Source function must return an object containing ".url" key for group "'+d+'"'}),m.print());a.populateSource([],d);return}a.requests[d]=c}var l;d=!1;var h={};~c.request.url.indexOf("{{query}}")&&(d||(c=b.extend(!0,{},c),d=!0),c.request.url=c.request.url.replace("{{query}}",encodeURIComponent(a.query)));if(c.request.data)for(var f in c.request.data)if(c.request.data.hasOwnProperty(f)&&~String(c.request.data[f]).indexOf("{{query}}")){d||
(c=b.extend(!0,{},c),d=!0);c.request.data[f]=c.request.data[f].replace("{{query}}",a.query);break}b.ajax(c.request).done(function(b,d,g){for(var e,f=0,k=c.validForGroup.length;f<k;f++)e=c.validForGroup[f],l=a.requests[e],l.callback.done instanceof Function&&(h[e]=l.callback.done.call(a,b,d,g),Array.isArray(h[e])&&"object"===typeof h[e]||!a.options.debug||(m.log({node:a.selector,function:"Ajax.callback.done()",message:"Invalid returned data has to be an Array"}),m.print()))}).fail(function(b,d,g){for(var e=
0,h=c.validForGroup.length;e<h;e++)l=a.requests[c.validForGroup[e]],l.callback.fail instanceof Function&&l.callback.fail.call(a,b,d,g);a.options.debug&&(m.log({node:a.selector,function:"Ajax.callback.fail()",arguments:JSON.stringify(c.request),message:d}),console.log(g),m.print())}).always(function(b,d,e){for(var f,k=0,r=c.validForGroup.length;k<r;k++){f=c.validForGroup[k];l=a.requests[f];l.callback.always instanceof Function&&l.callback.always.call(a,b,d,e);if("object"!==typeof e)break;a.populateSource(null!==
b&&"function"===typeof b.promise&&[]||h[f]||b,l.extra.group,l.extra.path||l.request.path);--g;0===g&&a.helper.executeCallback.call(a,a.options.callback.onReceiveRequest,[a.node,a.query])}}).then(function(b,d){for(var g=0,e=c.validForGroup.length;g<e;g++)l=a.requests[c.validForGroup[g]],l.callback.then instanceof Function&&l.callback.then.call(a,b,d)})}(h,this.requests[h])}},populateSource:function(a,c,e){var d=this,g=this.options.source[c],l=g.ajax&&g.data;e&&"string"===typeof e&&(a=this.helper.namespace.call(this,
e,a));"undefined"===typeof a&&this.options.debug&&(m.log({node:this.selector,function:"populateSource()",arguments:e,message:"Invalid data path."}),m.print());Array.isArray(a)||(this.options.debug&&(m.log({node:this.selector,function:"populateSource()",arguments:JSON.stringify({group:c}),message:"Invalid data type, must be Array type."}),m.print()),a=[]);l&&("function"===typeof l&&(l=l()),Array.isArray(l)?a=a.concat(l):this.options.debug&&(m.log({node:this.selector,function:"populateSource()",arguments:JSON.stringify(l),
message:"WARNING - this.options.source."+c+".data Must be an Array or a function that returns an Array."}),m.print()));var h=g.display?"compiled"===g.display[0]?g.display[1]:g.display[0]:"compiled"===this.options.display[0]?this.options.display[1]:this.options.display[0],f=0;for(l=a.length;f<l;f++)if(null===a[f]||"boolean"===typeof a[f])this.options.debug&&(m.log({node:this.selector,function:"populateSource()",message:"WARNING - NULL/BOOLEAN value inside "+c+"! The data was skipped."}),m.print());
else{if("string"===typeof a[f]){var k={};k[h]=a[f];a[f]=k}a[f].group=c}if(!this.hasDynamicGroups&&this.dropdownFilter.dynamic.length){var n={};f=0;for(l=a.length;f<l;f++)for(var p=0,y=this.dropdownFilter.dynamic.length;p<y;p++)if(k=this.dropdownFilter.dynamic[p].key,h=a[f][k])this.dropdownFilter.dynamic[p].value||(this.dropdownFilter.dynamic[p].value=[]),n[k]||(n[k]=[]),~n[k].indexOf(h.toLowerCase())||(n[k].push(h.toLowerCase()),this.dropdownFilter.dynamic[p].value.push(h))}if(this.options.correlativeTemplate)if(l=
g.template||this.options.template,k="","function"===typeof l&&(l=l.call(this,"",{})),l){if(Array.isArray(this.options.correlativeTemplate))for(f=0,l=this.options.correlativeTemplate.length;f<l;f++)k+="{{"+this.options.correlativeTemplate[f]+"}} ";else k=l.replace(/<.+?>/g," ").replace(/\s{2,}/," ").trim();f=0;for(l=a.length;f<l;f++)a[f].compiled=b("<textarea />").html(k.replace(/\{\{([\w\-\.]+)(?:\|(\w+))?}}/g,function(b,c){return d.helper.namespace.call(d,c,a[f],"get","")}).trim()).text();g.display?
~g.display.indexOf("compiled")||g.display.unshift("compiled"):~this.options.display.indexOf("compiled")||this.options.display.unshift("compiled")}else this.options.debug&&(m.log({node:this.selector,function:"populateSource()",arguments:String(c),message:"WARNING - this.options.correlativeTemplate is enabled but no template was found."}),m.print());this.options.callback.onPopulateSource&&(a=this.helper.executeCallback.call(this,this.options.callback.onPopulateSource,[this.node,a,c,e]),!this.options.debug||
...
a,c,e]),!this.options.debug||a&&Array.isArray(a)||(m.log({node:this.selector,function:"callback.populateSource()",message:'callback.onCacheSave must return the "data" parameter'}),m.print())),e=JSON.stringify({data:a,ttl:(new Date).getTime()+k}),l&&(e=LZString.compressToUTF16(e)),window[g].setItem("TYPEAHEAD_"+this.selector+":"+c,e));this.incrementGeneratedGroup()},incrementGeneratedGroup:function(){this.generatedGroupCount++;if(this.generatedGroupCount===this.generateGroups.length){this.xhr={};for(var a=
...
this.options.callback.onResult,[this.node,this.query,this.result,this.resultCount,this.resultCountPerGroup]),this.isDropdownEvent&&(this.helper.executeCallback.call(this,this.options.callback.onDropdownFilter,[this.node,this.query,this.filters.dropdown,this.result]),this.isDropdownEvent=!1))},searchResultData:function(){var a=this.groupBy,c=null,e=this.query.toLowerCase(),f=this.options.maxItem,h=this.options.maxItemPerGroup,k=this.filters.dynamic&&!this.helper.isEmpty(this.filters.dynamic),n={},
C="function"===typeof this.options.matcher&&this.options.matcher;this.options.accent&&(e=this.helper.removeAccent.call(this,e));for(var q=0,t=this.searchGroups.length;q<t;++q){var p=this.searchGroups[q];if(!this.filters.dropdown||"group"!==this.filters.dropdown.key||this.filters.dropdown.value===p){var y="undefined"!==typeof this.options.source[p].filter?this.options.source[p].filter:this.options.filter;var F="function"===typeof this.options.source[p].matcher&&this.options.source[p].matcher||C;for(var D=
0,B=this.source[p].length;D<B&&(!(this.resultItemCount>=f)||this.options.callback.onResult);D++)if(!k||this.dynamicFilter.validate.apply(this,[this.source[p][D]])){var x=this.source[p][D];if(!(null===x||"boolean"===typeof x||this.options.multiselect&&!this.isMultiselectUniqueData(x)||this.filters.dropdown&&(x[this.filters.dropdown.key]||"").toLowerCase()!==(this.filters.dropdown.value||"").toLowerCase())){(c="group"===a?p:x[a]?x[a]:x.group)&&!this.tmpResult[c]&&(this.tmpResult[c]=[],this.resultCountPerGroup[c]=
0);if(h&&"group"===a&&this.tmpResult[c].length>=h&&!this.options.callback.onResult)break;var u=this.options.source[p].display||this.options.display;for(var A=0,K=u.length;A<K;++A){if(!1!==y){var H=/\./.test(u[A])?this.helper.namespace.call(this,u[A],x):x[u[A]];if("undefined"===typeof H||""===H){this.options.debug&&(n[A]={display:u[A],data:x});continue}H=this.helper.cleanStringFromScript(H)}if("function"===typeof y){var z=y.call(this,x,H);if(void 0===z)break;if(!z)continue;"object"===typeof z&&(x=
z)}if(~[void 0,!0].indexOf(y)){var G=H;G=G.toString().toLowerCase();this.options.accent&&(G=this.helper.removeAccent.call(this,G));z=G.indexOf(e);if(this.options.correlativeTemplate&&"compiled"===u[A]&&0>z&&/\s/.test(e)){var L=!0;var J=e.split(" ");for(var I=0,M=J.length;I<M;I++)if(""!==J[I]){if(!~G.indexOf(J[I])){L=!1;break}G=G.replace(J[I],"")}}if(0>z&&!L)continue;if(this.options.offset&&0!==z)continue;if(F){z=F.call(this,x,H);if(void 0===z)break;if(!z)continue;"object"===typeof z&&(x=z)}}this.resultCount++;
this.resultCountPerGroup[c]++;if(this.resultItemCount<f){if(h&&this.tmpResult[c].length>=h)break;this.tmpResult[c].push(b.extend(!0,{matchedKey:u[A]},x));this.resultItemCount++}break}if(!this.options.callback.onResult){if(this.resultItemCount>=f)break;if(h&&this.tmpResult[c].length>=h&&"group"===a)break}}}}}this.options.debug&&!this.helper.isEmpty(n)&&(m.log({node:this.selector,function:"searchResult()",arguments:JSON.stringify(n),message:"Missing keys for display, make sure options.display is set properly."}),
m.print());if(this.options.order)for(p in u=[],this.tmpResult)if(this.tmpResult.hasOwnProperty(p)){q=0;for(t=this.tmpResult[p].length;q<t;q++)a=this.options.source[this.tmpResult[p][q].group].display||this.options.display,~u.indexOf(a[0])||u.push(a[0]);this.tmpResult[p].sort(this.helper.sort(u,"asc"===this.options.order,function(a){return a.toString().toUpperCase()}))}p=[];u=[];u="function"===typeof this.options.groupOrder?this.options.groupOrder.apply(this,[this.node,this.query,this.tmpResult,this.resultCount,
this.resultCountPerGroup]):Array.isArray(this.options.groupOrder)?this.options.groupOrder:"string"===typeof this.options.groupOrder&&~["asc","desc"].indexOf(this.options.groupOrder)?Object.keys(this.tmpResult).sort(this.helper.sort([],"asc"===this.options.groupOrder,function(a){return a.toString().toUpperCase()})):Object.keys(this.tmpResult);q=0;for(t=u.length;q<t;q++)p=p.concat(this.tmpResult[u[q]]||[]);this.groups=JSON.parse(JSON.stringify(u));this.result=p},buildLayout:function(){this.buildHtmlLayout();
...
""));for(var k,m,n,q,t,p,y,F,D,B=this.groupTemplate&&this.result.length&&e.groups||[],x,u=0,A=this.result.length;u<A;++u)n=this.result[u],k=n.group,q=!this.options.multiselect&&this.options.source[n.group].href||this.options.href,y=[],F=this.options.source[n.group].display||this.options.display,this.options.group&&(k=n[this.options.group.key],this.options.group.template&&("function"===typeof this.options.group.template?m=this.options.group.template.call(this,n):"string"===typeof this.options.group.template&&
(m=this.options.group.template.replace(/\{\{([\w\-\.]+)}}/gi,function(a,b){return e.helper.namespace.call(e,b,n,"get","")}))),f.find('[data-search-group="'+k+'"]')[0]||(this.groupTemplate?f.find('[data-group-template="'+k+'"] ul'):f).append(b("<li/>",{class:e.options.selector.group,html:b("<a/>",{href:"javascript:;",html:m||k,tabindex:-1}),"data-search-group":k}))),this.groupTemplate&&B.length&&(x=B.indexOf(k||n.group),~x&&B.splice(x,1)),q=b("<li/>",{class:e.options.selector.item+" "+e.options.selector.group+
"-"+this.helper.slugify.call(this,k),disabled:n.disabled?!0:!1,"data-group":k,"data-index":u,html:b("<a/>",{href:q&&!n.disabled?n.href=e.generateHref.call(e,q,n):"javascript:;",html:function(){if(t=n.group&&e.options.source[n.group].template||e.options.template)"function"===typeof t&&(t=t.call(e,e.query,n)),p=t.replace(/\{\{([^\|}]+)(?:\|([^}]+))*}}/gi,function(a,b,d){a=e.helper.cleanStringFromScript(String(e.helper.namespace.call(e,b,n,"get","")));d=d&&d.split("|")||[];~d.indexOf("slugify")&&(a=
e.helper.slugify.call(e,a));~d.indexOf("raw")||!0===e.options.highlight&&c&&~F.indexOf(b)&&(a=e.helper.highlight.call(e,a,c.split(" "),e.options.accent));return a});else{for(var a=0,d=F.length;a<d;a++)D=/\./.test(F[a])?e.helper.namespace.call(e,F[a],n,"get",""):n[F[a]],"undefined"!==typeof D&&""!==D&&y.push(D);p='<span class="'+e.options.selector.display+'">'+e.helper.cleanStringFromScript(String(y.join(" ")))+"</span>"}if(!0===e.options.highlight&&c&&!t||"any"===e.options.highlight)p=e.helper.highlight.call(e,
...
[e.node,b(this),d,a])});c.on("mouseleave",function(a){d.disabled||e.clearActiveItem();e.helper.executeCallback.call(e,e.options.callback.onLeave,[e.node,b(this),d,a])})}(u,n,q),(this.groupTemplate?f.find('[data-group-template="'+k+'"] ul'):f).append(q);if(this.result.length&&B.length)for(u=0,A=B.length;u<A;++u)f.find('[data-group-template="'+B[u]+'"]').remove();this.resultHtml=f}},generateHref:function(a,b){var d=this;"string"===typeof a?a=a.replace(/\{\{([^\|}]+)(?:\|([^}]+))*}}/gi,function(a,c,
...
typeof e?e:void 0;if(!~a.indexOf("."))return b[a]||d;a=a.split(".");b=b||window;c=c||"get";for(var g,f=0,h=a.length;f<h;f++){g=a[f];if("undefined"===typeof b[g]){if(~["get","delete"].indexOf(c))return"undefined"!==typeof e?e:void 0;b[g]={}}if(~["set","create","delete"].indexOf(c)&&f===h-1)if("set"===c||"create"===c)b[g]=d;else return delete b[g],!0;b=b[g]}return b},typeWatch:function(){var a=0;return function(b,d){clearTimeout(a);a=setTimeout(b,d)}}()}};b.fn.typeahead=b.typeahead=function(a){return n.typeahead(this,
a)};var n={typeahead:function(a,c){if(c&&c.source&&"object"===typeof c.source){if("function"===typeof a){if(!c.input){m.log({node:a.selector,function:"$.typeahead()",message:'Undefined "options.input" - Typeahead dropped'});m.print();return}a=b(c.input)}"undefined"===typeof a[0].value&&(a[0].value=a.text());if(a.length){if(1===a.length)return a[0].selector=a.selector||c.input||a[0].nodeName.toLowerCase(),window.Typeahead[a[0].selector]=new k(a,c);for(var d={},e,f=0,g=a.length;f<g;++f)e=a[f].nodeName.toLowerCase(),
