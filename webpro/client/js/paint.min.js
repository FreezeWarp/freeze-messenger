...
Handlebars.registerHelper("contains",function(a,b,c){b=b instanceof Array?b:[b];return-1<b.indexOf(a)?c.fn(this):""});Handlebars.registerHelper("byte",function(a){var b=a;for(i in window.phrases.byteUnits)a>i&&(b=a/i+window.phrases.byteUnits[i]);return b});
Handlebars.registerHelper("ifCond",function(a,b,c,d){switch(b){case "==":return a==c?d.fn(this):d.inverse(this);case "===":return a===c?d.fn(this):d.inverse(this);case "!=":return a!=c?d.fn(this):d.inverse(this);case "!==":return a!==c?d.fn(this):d.inverse(this);case "<":return a<c?d.fn(this):d.inverse(this);case "<=":return a<=c?d.fn(this):d.inverse(this);case ">":return a>c?d.fn(this):d.inverse(this);case ">=":return a>=c?d.fn(this):d.inverse(this);case "&&":return a&&c?d.fn(this):d.inverse(this);
case "||":return a||c?d.fn(this):d.inverse(this);default:return d.inverse(this)}});function fim_renderHandlebarsInPlace(a){var b=a.attr("id"),c=a.html();c=Handlebars.compile(c);$("#active-"+b).remove();$('<div id="active-'+b+'">'+c(fim_getHandlebarsPhrases())+"</div>").insertAfter(a)}function fim_renderHandlebars(a,b){var c=a.attr("id");a=a.html();a=Handlebars.compile(a);$("#active-"+c).remove();$(b).html($('<div id="active-'+c+'">'+a(fim_getHandlebarsPhrases())+"</div>"))}
