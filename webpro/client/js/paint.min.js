...
function $l(a,b,c){var d=!1,e="",f=!1;stringNameParts=a.split(".");$.each(stringNameParts,function(a,b){e+="['"+b+"']";if(void 0===eval("window.phrases"+e+" || extra"+e))return f=!0,!1});if(!1===f&&(d=eval("window.phrases"+e+" || extra"+e)))return b&&$.each(b,function(a,b){d=d.replace("{{{{"+a+"}}}}",b)}),d;console.log('Missing phrase "'+a+'"');return"~~"+a}Handlebars.registerHelper("contains",function(a,b,c){b=b instanceof Array?b:[b];return-1<b.indexOf(a)?c.fn(this):""});
