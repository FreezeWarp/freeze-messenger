...
function fim_messageFormat(a,b){var c=a.text,d=a.time,e=a.id,f=a.roomId,h=a.flag,k=Number(a.userId);a=Number(a.anonId);var g=fim_getUsernameDeferred(k);switch(h){case "source":c=fim_youtubeParse(c);break;case "image":c=fim_formatAsImage(c);break;case "video":c=fim_formatAsVideo(c);break;case "audio":c=fim_formatAsAudio(c);break;case "email":c=fim_formatAsEmail(c);break;case "url":case "text":case "html":case "archive":case "application":case "other":c=fim_formatAsUrl(c);break;default:c=$("<span>").text(c),
jQuery.each({"```":"pre","`":"code"},function(a,b){c.contents().filter(function(){return 3===this.nodeType}).each(function(){return $(this).replaceWith(fim_regexTokenizer(new RegExp("\\"+a+"([\\s\\S]+?)\\"+a,"g"),$(this).text(),function(a){return $("<"+b+">").text(a[1])}).html())})}),c.find('*:not(:has("*"))').add(c.contents().add(c).filter(function(){return 3===this.nodeType})).each(function(){var a=fim_regexTokenizer(regexs.url,$(this).text(),function(a){var b="";a[0].match(regexs.url2)&&(b=a[0].replace(regexs.url2,
"$2"),a[0]=a[0].replace(regexs.url2,"$1"));return a[0].match(regexs.youtubeFull)||a[0].match(regexs.youtubeShort)?fim_youtubeParse(a[0]).append(document.createTextNode(b)):a[0].match(regexs.image)?fim_formatAsImage(a[0]).append(document.createTextNode(b)):fim_formatAsUrl(a[0]).append(document.createTextNode(b))},3!==this.nodeType?$(this).text(""):null);3===this.nodeType&&$(this).replaceWith(a.html())}),jQuery.each({"~~":"del","*":"strong",_:"em"},function(a,b){c.contents().filter(function(){return 3===
this.nodeType}).each(function(){return $(this).replaceWith(fim_regexTokenizer(new RegExp("\\"+a+"([\\s\\S]+?)\\"+a,"g"),$(this).text(),function(c){console.log("match",a,b,c);return $("<"+b+">").text(c[1])}).html())})}),jQuery.each(serverSettings.emoticons,function(a,b){c.find("strong, em, del").add(c.contents().add(c).filter(function(){return 3===this.nodeType})).each(function(){var a=fim_regexTokenizer(new RegExp(b.emoticonText.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&"),"gi"),$(this).text(),
function(){return $("<img>").attr("src",b.emoticonFile)},3!==this.nodeType?$(this).text(""):null);3===this.nodeType&&$(this).replaceWith(a.html())})}),c.find('*:not(:has("*"))').add(c.contents().add(c).filter(function(){return 3===this.nodeType})).each(function(){var a=fim_regexTokenizer(new RegExp(/\n/g,"g"),$(this).text(),function(){return $("<br>")},3!==this.nodeType?$(this).text(""):null);3===this.nodeType&&$(this).replaceWith(a.html())})}switch(b){case "table":var m=$('<tr style="word-wrap: break-word;">').attr({id:"archiveMessage' + messageId + '"}).append($("<td>").append(fim_buildUsernameTag($('<span class="userName userNameTable"></span>'),
k,g,a))).append($('<td class="d-none d-sm-table-cell">').text(fim_dateFormat(d))).append($("<td>").append(fim_buildMessageLine(c,e,k,f,d,g).append(c)));break;case "list":b=fim_buildMessageLine(c,e,k,f,d,g),settings.showAvatars&&b.popover({content:function(){return fim_dateFormat($(this).attr("data-time"))},html:!1,trigger:"hover",placement:"bottom"}),m=$("<span>").attr({id:"message"+e,"class":"messageLine"+(settings.showAvatars?" messageLineAvatar":"")}).append($('<span class="usernameDate">').append(fim_buildUsernameTag($("<span>"),
k,g,a,settings.showAvatars,!settings.showAvatars)).append(settings.showAvatars?"":$('<span class="date">').css({"padding-right":"10px","letter-spacing":"-1px"}).text("@ ").append($("<em>").text(fim_dateFormat(d))))).append(b)}return m}function fim_buildUsernameTag(a,b,c,d,e,f){c||(c=fim_getUsernameDeferred(b));fim_buildUsernameTagPromise(a,b,c,d,e,f);return a}
function fim_buildUsernameTagPromise(a,b,c,d,e,f){var h=$.Deferred();void 0==e&&(e=!0);void 0==f&&(f=!0);d||(d="");$.when(c).then(function(c){var g=c[b].name+d,k=c[b].nameFormat,l=c[b].avatar?c[b].avatar:"images/blankperson.png";a.addClass("userName").addClass(e?" userNameAvatar":"").attr({style:f?k:"","data-style":k,"data-userId":b,"data-userName":g,"data-avatar":l,"data-bio":c[b].bio,"data-profile":c[b].profile,"data-joinDate":c[b].joinDate,tabindex:1E3}).append(e?$("<img>").attr({alt:g,src:l?l:
...
$(this).replaceWith(fim_buildMessageLine(a.val(),b,c,d,e,f)),g.preventDefault())});fimApi.getMessages({roomId:d,id:b},{end:function(b){a.text(b[0].text)}});$.each(this.attributes,function(){a.attr(this.name,this.value)});a.css("width","100%");$(this).replaceWith(a)});$.when(f).then(function(a){h.attr("style",a[c].messageFormatting)});return h}function fim_getUsernameDeferred(a){return $.when(Resolver.resolveUsersFromIds([a]))}
function fim_getRoomNameDeferred(a){return $.when(Resolver.resolveRoomsFromIds([a]))}function fim_loadTheme(a){a="css"===a?"https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.3/css/bootstrap.min.css":"https://maxcdn.bootstrapcdn.com/bootswatch/4.0.0-beta.3/"+a+"/bootstrap.min.css";var b=$("#bootstrapTheme");b.length?b.attr("href",a):$("<link/>",{id:"bootstrapTheme",rel:"stylesheet",type:"text/css",crossorigin:"anonymous",href:a}).appendTo("head")}
