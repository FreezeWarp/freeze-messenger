...
(window.serverSettings.fileUploads.extensionChangesReverse[c]=[]);window.serverSettings.fileUploads.extensionChangesReverse[c].push(a)})}})).then(function(){window.serverSettings.installUrl!==window.location.protocol+"//"+window.location.host+window.directory&&dia.error(window.phrases.errorBadInstall);window.fimApi=new fimApi(window.serverSettings);fimApi.registerDefaultExceptionHandler(function(a){dia.exception(a)});window.standard=new standard;window.popup=new popup;$(document).ready(function(){fim_renderHandlebarsInPlace($("#entry-template"));
$("body").popover({selector:".userName",content:function(){var a=$('<div class="row no-gutters">'),b=$('<div class="col">').append($('<h4 class="userName">').attr({"data-userId":userId,style:$(this).attr("data-style")}).css("font-weight","bold").text($(this).attr("data-userName")),$("<hr>"));$(this).attr("data-bio")&&b.append($("<div>").text($(this).attr("data-bio")));$(this).attr("data-profile")&&b.append($("<div>").append($("<em><strong>Profile</strong></em>"),": ",$('<a target="_blank">').attr("href",
$(this).attr("data-profile")).text($(this).attr("data-profile"))));$(this).attr("data-joinDate")&&b.append($("<div>").append($("<em><strong>Member Since</strong></em>"),": ",$("<span>").text(fim_dateFormat($(this).attr("data-joinDate"),{year:"numeric",month:"numeric",day:"numeric"}))));a.append($('<div class="col-sm-auto">').append($('<img style="max-height: 200px; max-width: 200px;" class="mr-2">').attr("src",$(this).attr("data-avatar"))),b);return a.prop("outerHTML")},html:!0,trigger:"focus",placement:"auto",
delay:{show:50,hide:100}});var a={disabled:"bg-inverse",visible:"bg-primary",notSelectable:"not-selectable"},b={show:function(){window.restrictFocus="contextMenu"},hide:function(){window.restrictFocus=null}};$.contextMenu({selector:".messageText, .messageText *",classNames:a,events:b,zIndex:5E3,items:{"delete":{name:"Delete",callback:function(){var a=$(this).closest(".messageText").attr("data-roomId"),b=$(this).closest(".messageText").attr("data-messageid");dia.confirm({text:"Are you sure you want to delete this message?",
"true":function(){fimApi.deleteMessage(a,b,{end:function(){dia.info("The message was deleted.","success")}})}})},visible:function(){return $(this).closest(".messageLine").find(".userName").attr("data-userid")==window.userId&&window.activeLogin.userData.permissions.deleteOwnPosts||window.openObjectInstance.roomData.permissions.moderate}},link:{name:"Message Link",callback:function(){var a=$(this).closest(".messageText").attr("data-roomId"),b=$(this).closest(".messageText").attr("data-messageid");dia.full({title:"Link to this Message",
content:$("<span>").text("This message can be bookmarked using the following archive link:").append($("<br>"),$("<br>"),$("<input>").attr({type:"text",value:currentLocation+"#archive#room="+a+"#lastMessage="+b,autofocus:!0,id:"messageLink-"+a+"-"+b,style:"width: 100%;"})).prop("outerHTML"),oF:function(){$("#messageLink-"+a+"-"+b).focus().select()}})}},edit:{name:"Edit",callback:function(){$("#message"+$(this).closest(".messageText").attr("data-messageid")+" .messageText").dblclick()},visible:function(){return $(this).closest(".messageLine").find(".userName").attr("data-userid")==
window.userId&&window.activeLogin.userData.permissions.editOwnPosts}},click:{name:"URL",callback:function(){if("IMG"===$(this).prop("tagName")){var a=$(this).attr("src").replace(/&thumbnailWidth=[^&]*/,"").replace(/&thumbnailHeight=[^&]*/,"");dia.full({title:"Copy Image URL",content:$("<div>").append($("<img>").attr({src:a,style:"width: 100%;"}),$("<br>"),$("<br>"),$("<input>").attr({type:"text",name:"url",value:a,style:"width: 100%"})).prop("outerHTML"),width:800,position:"top",oF:function(){$("input[name=url]",
this).first().focus()}})}else dia.full({title:"Copy URL",position:"top",content:$("<input>").attr({type:"text",name:"url",value:$(this).closest(".messageText").attr("href"),style:"width: 100%;"}).prop("outerHTML"),width:800,oF:function(){$("input[name=url]",this).first().focus()}})},visible:function(a,b){console.log("visible",$(this),b);return"IMG"===$(this).prop("tagName")||"A"===$(this).prop("tagName")}}}});$.contextMenu({selector:".userName",classNames:a,events:b,zIndex:5E3,items:{profile:{name:"Profile",
...
[window.userId,$(this).attr("data-userid")].join()},visible:function(){return $(this).attr("data-userid")!=window.userId}},kick:{name:"Kick",callback:function(){popup.kick($(this).attr("data-userid"),window.roomId)},visible:function(){return window.openObjectInstance instanceof popup.room&&window.openObjectInstance.roomData.permissions.moderate&&$(this).attr("data-userid")!=window.activeLogin.userData.id}},ban:{name:"Ban",callback:function(){alert("Functionality coming soon.")},visible:function(){return window.activeLogin.userData.permissions.modUsers&&
...
function(){$q("Loading failed. Please refresh.")});
