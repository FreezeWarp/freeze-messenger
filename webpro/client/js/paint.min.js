...
" from your ignore list.")}})},visible:function(){return $(this).attr("data-userId")!=window.activeLogin.userData.id&&0<=window.activeLogin.userData.ignoredUsers.indexOf($(this).attr("data-userId"))}}}});$.contextMenu({selector:".roomName",classNames:a,events:b,zIndex:5E3,items:{edit:{name:"Edit",callback:function(){window.location.hash="#editRoom#room="+$(this).attr("data-roomId")},visible:function(){return window.activeLogin.userData.permissions.modRooms}},archive:{name:"View Archive",callback:function(){window.location.hash=
"#archive#room="+$(this).attr("data-roomId")}},enter:{name:"Enter",callback:function(){window.location.hash="#room="+$(this).attr("data-roomId")}},fav:{name:"Favourite",callback:function(){fimApi.favRoom($(this).attr("data-roomId"));window.activeLogin.userData.favRooms.push($(this).attr("data-roomId"))},visible:function(){return 0>window.activeLogin.userData.favRooms.indexOf($(this).attr("data-roomId"))}},unfav:{name:"Unfavourite",callback:function(){fimApi.unfavRoom($(this).attr("data-roomId"));
window.activeLogin.userData.favRooms.remove($(this).attr("data-roomId"))},visible:function(){return 0<=window.activeLogin.userData.favRooms.indexOf($(this).attr("data-roomId"))}}}});$(window).bind("hashchange",fim_hashParse);showLogin=function(){window.location.hash.match(/#sessionHash=/)?standard.initialLogin({grantType:"access_token",sessionHash:window.location.hash.match(/#sessionHash=([^#]+)/)[1],error:function(){window.userId||popup.login()}}):$.cookie("webpro_refreshToken")?standard.initialLogin({grantType:"refresh_token",
refreshToken:$.cookie("webpro_refreshToken"),error:function(){window.userId||popup.login()}}):$.cookie("webpro_username")?standard.initialLogin({username:$.cookie("webpro_username"),password:$.cookie("webpro_password"),error:function(){window.userId||popup.login()}}):popup.login()};showLogin();return!1})},function(){$q("Loading failed. Please refresh.")});
