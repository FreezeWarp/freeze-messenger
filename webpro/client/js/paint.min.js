...
a.find("*").add(a).contents().filter(function(){return 3===this.nodeType}).each(function(){$(this).replaceWith(fim_regexTokenizer(/\n/g,$(this).text(),function(){return $("<br>")}))})}k.attr({"class":"messageText","data-messageId":c,"data-roomId":e,"data-time":f,tabindex:1E3}).append(a);if(window.userId==d&&window.activeLogin.userData.permissions.editOwnPosts)k.on("dblclick",function(){var a=$("<textarea>").on("keydown",function(h){13!=h.keyCode||h.shiftKey?27==h.keyCode&&($(this).replaceWith(fim_buildMessageLine(a.text(),
