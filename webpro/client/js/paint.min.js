...
events:b,items:{delete:{name:"Delete",callback:function(){dia.confirm({text:"Are you sure you want to delete this message?","true":function(){fimApi.deleteMessage($(this).attr("data-roomId"),$(this).attr("data-messageid"),{end:function(){dia.info("The message was deleted.","success")}})}})}},link:{name:"Message Link",callback:function(){var a=$(this).attr("data-roomId"),b=$(this).attr("data-messageid");dia.full({title:"Link to this Message",content:$("<span>").text("This message can be bookmarked using the following archive link:").append($("<br>"),
$("<br>"),$("<input>").attr({type:"text",value:currentLocation+"#archive#room="+a+"#lastMessage="+b,autofocus:!0,id:"messageLink-"+a+"-"+b,style:"width: 100%;"})).prop("outerHTML"),oF:function(){$("#messageLink-"+a+"-"+b).focus().select()}})}},edit:{name:"Edit",callback:function(){$("#message"+$(this).attr("data-messageid")+" .messageText").dblclick()},visible:function(){return $(this).parent(".messageLine").find(".userName").attr("data-userid")==window.userId&&window.activeLogin.userData.permissions.editOwnPosts}},
...
position:"top",content:$("<input>").attr({type:"text",name:"url",value:$(this).attr("href"),style:"width: 100%;"}).prop("outerHTML"),width:800,oF:function(){$("input[name=url]",this).first().focus()}})},visible:function(a,b){console.log("visible",$(this),b);return"IMG"===$(this).prop("tagName")||"A"===$(this).prop("tagName")}}}});$.contextMenu({selector:".userName",classNames:a,events:b,items:{profile:{name:"Profile",callback:function(){$.when(Resolver.resolveUsersFromIds([userId])).then(function(a){dia.full({title:"User Profile",
