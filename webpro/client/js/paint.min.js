...
var favicon=$("#favicon").attr("href"),requestSettings={serverSentEvents:!1},timers={t1:!1},messageIndex={},settingNames={disableFormatting:16,disableImages:32,disableVideos:64,reversePostOrder:1024,showAvatars:2048,hideTimes:4096,audioDing:8192,disableRightClick:1048576,webkitNotifications:536870912},settingsBitfield=$.getCookie("webpro_settings",settingNames.showAvatars+settingNames.audioDing);
window.settings={theme:$.getCookie("webpro_theme","css"),audioVolume:$.getCookie("webpro_audioVolume",.5),disableFormatting:!!(settingsBitfield&settingNames.disableFormatting),disableImages:!!(settingsBitfield&settingNames.disableImages),disableVideos:!!(settingsBitfield&settingNames.disableVideos),reversePostOrder:!!(settingsBitfield&settingNames.reversePostOrder),showAvatars:!!(settingsBitfield&settingNames.showAvatars),hideTimes:!!(settingsBitfield&settingNames.hideTimes),audioDing:!!(settingsBitfield&
settingNames.audioDing),disableRightClick:!!(settingsBitfield&settingNames.disableRightClick),webkitNotifications:!!(settingsBitfield&settingNames.webkitNotifications)};if(1<window.settings.audioVolume||0>window.settings.audioVolume)console.error("audioVolume was "+window.settings.audioVolume+"; set to .5"),window.settings.audioVolume=.5;
