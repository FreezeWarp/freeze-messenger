...
function fim_buildMessageLine(a,b,c,d,e,f){var h=$("<span>");h.attr({"class":"messageText","data-messageId":b,"data-roomId":d,"data-time":e,tabindex:1E3}).append(a);if(window.userId==c&&window.permissions.editOwnPosts)h.on("dblclick",function(){var a=$("<textarea>").text($(this).text()).onEnter(function(){fimApi.editMessage(d,b,{message:a.val()});$(this).replaceWith(fim_buildMessageLine(a.val(),b,c,d,e,f))});$.each(this.attributes,function(){a.attr(this.name,this.value)});$(this).replaceWith(a)});
