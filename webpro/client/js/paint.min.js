...
function fim_buildUsernameTagPromise(a,b,c,d,e,f){var h=$.Deferred();void 0==e&&(e=!0);void 0==f&&(f=!0);d||(d="");$.when(c).then(function(c){var g=c[b].name+d,l=c[b].nameFormat,m=c[b].avatar?c[b].avatar:"images/blankperson.png";a.attr({"class":"userName"+(e?" userNameAvatar":""),style:f?l:"","data-style":l,"data-userId":b,"data-userName":g,"data-avatar":m,"data-bio":c[b].bio,"data-profile":c[b].profile,"data-joinDate":c[b].joinDate,tabindex:1E3}).append(e?$("<img>").attr({alt:g,src:m?m:"images/blankperson.png"}):
