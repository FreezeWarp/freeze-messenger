...
function encrypt_md5() {
  ...
  hex_hmac_md5 : function(k, d) { return rstr2hex(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
  b64_hmac_md5 : function(k, d) { return rstr2b64(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
  any_hmac_md5 : function(k, d, e) { return rstr2any(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d)), e); }

  /*
   * Perform a simple self-test to see if the VM is working
   */
  md5_vm_test : function() { return hex_md5("abc").toLowerCase() == "900150983cd24fb0d6963f7d28e17f72"; }

  /*
   * Calculate the MD5 of a raw string
   */
  rstr_md5 : function(s) { return binl2rstr(binl_md5(rstr2binl(s), s.length * 8));}
