...
(1, 'brandingTitle', 'FreezeMessenger v3-r061019 (Pre-Beta)', 'フリーズ の メッセンジャー'),
...
(33, 'settingsAudioDingLabel', 'Enable Audio Ding:', ''),
(34, 'settingsAudioDingBlurb', 'If checked, a "ding" will sound whenever a new message is received and you aren''t there to see it.', ''),
