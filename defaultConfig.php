...
// All Seconds
  ...
  'permissionsCacheRefresh' => 60, // int The number of seconds after which the permissions cache will be refreshed. Because this is a *full* cache, the table will be read in its entirety every time this ammount of time elapses, so it can only be so low. However, permissions do not come into effect until they appear in the cache, so if this is too high, the kicks functionality effectively breaks down.
