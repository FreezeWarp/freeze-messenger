...
$defaultConfig = array(
    ...
    'censorWordsCacheRefresh' => 1800, // int How often a room's applied censor words should be refreshed. The value should be large enough to ensure that messageSend doesn't require rebuilding the cache frequently, but low enough that changes to the active lists doesn't take a long time to refresh.
